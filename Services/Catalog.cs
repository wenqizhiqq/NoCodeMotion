...
namespace NoCodeMotion.Services
{
    ...
    public static class Catalog
    {
        ...
        public static void SetAxis(IEnumerable<string> names) => Set("Axis", names);
        public static void SetIo(IEnumerable<string> names) => Set("Io", names);
        public static void SetCylinder(IEnumerable<string> names) => Set("Cylinder", names);
        public static void SetComm(IEnumerable<string> names) => Set("Comm", names);

        private static void Set(string category, IEnumerable<string> names)
        {
