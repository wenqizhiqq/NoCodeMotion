...
//   源: MotionCardRes/PCI9014/CardRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.PCI9014
{
    public class CardRealization : ICard
    {
        ...
        /// </summary>
        public SystemSupportMotionCardEnum HardwareName { get; set; } = SystemSupportMotionCardEnum.PCI9014;
        ...
        public int InitCard()
        {
            ...
            int[] card_id = null;
            int card_count = 0;
            var res = PCI9014SDK.Instance.InitCard(ref card_id, ref card_count);
            var errmsg = PCI9014SDK.Instance.GetErrorInfo(res);

            if (res != 0|| card_count==0)
            {
                card_count = 1;
                isInit = true;
                IsOffineMode = true;
        ...
        public int OpenCard(ref ushort cardnum, ref uint[] cardtypes, ref ushort[] CardID)
        {
            ...
            {  
                ...
                PCI9014SDK.Instance.homeConfigArray = new HomeParameModel[4 * (cardID[cardCount - 1] + 1)];
                ...
                {
                    if (this.HardwareName == SystemSupportMotionCardEnum.PCI9014) cardtypes[i] = 9014;
        ...
        public int GetCardLibVersion(int CardID, ref int LibVer, ref int pDriver_ver, ref int pLogic_ver)
        {
            ...
            try
            {
                ...
                uint pdriverVer = 0;
                uint plogicver = 0;
                int result = PCI9014SDK.Instance.GetCardVersion(CardID, ref libVer, ref pdriverVer, ref plogicver);
        ...
        public string GetErrorInfo(int ErrNum)
        {
            ...
            return PCI9014SDK.Instance.GetErrorInfo(ErrNum);
        }
