...
//   源: MotionCardRes/SLD1232/AxisRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.SLD1232
{
    public class AxisRealization : IAxis
    {
        ...
        {
            return SLD1232SDK.Instance.GetCardAxisCurrentSpeed((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return SLD1232SDK.Instance.CardAxisStopMulticoor(CardNo, crd, stop_mode);
        }
        ...
        {
            return SLD1232SDK.Instance.CardAxisChangeSpeed((ushort)CardNo, (ushort)axis, Curr_Vel, Taccdec);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisHcmp2dsetEnable(CardNo, hcmp, cmpEnable);
        }
        ...
        public int CardAxisArcMoveCenterUnit(ArcInterpolateparamModel arc)
        {
            ...
            return SLD1232SDK.Instance.CardAxisArcMoveMulticoor((ushort)arc.CardNo, (ushort)arc.Crd, AxisNums, Target_Pos, Cen_Pos, (ushort)arc.ArcDir, (ushort)arc.PosiMode);
        ...
        {
            return SLD1232SDK.Instance.GetCardCheckDoneMulticoor(CardNo, crd);
        }
        ...
        {
            return SLD1232SDK.Instance.CardAxisHomeMove(AxisWhichCardNo, AxisID);
        }
        ...
        {
            return SLD1232SDK.Instance.CardAxisGetHomeResult(CardNo, axis, ref status);
        }
        ...
        public int CardAxisLineUnit(LineInterpolateparamModel line)
        {
            ...
            return SLD1232SDK.Instance.CardAxisLineMulticoor(line.CardNo, line.Crd, line.Axis.Length, AxisNums, Target_Pos, line.PosiMode);
        ...
        {
            return SLD1232SDK.Instance.SetMultiVectorSpeed((ushort)parameter.CardNo, (ushort)parameter.Crd, parameter.minVel,
        ...
        {
            return SLD1232SDK.Instance.CardAxisPMove(mpm.CardNo, mpm.Axis, (int)mpm.Dist, (ushort)mpm.PosiMode);
        }
        ...
        {
            return SLD1232SDK.Instance.CardAxisVMove(mpm.CardNo, mpm.Axis, mpm.Dir);
        }
        /// <summary>
        /// 清除已添加的所有高速位置比较点
        /// </summary>
        ...
        {
            return SLD1232SDK.Instance.ClearCardHcmpPoints((ushort)CardNo, (ushort)hcmp);
        }
        ...
        public MotionParamModel GetCardAxisAccVel(MotionParamModel mpm)
        {
            ...
            SLD1232SDK.Instance.GetCardVectorProfileMulticoor(mpm.CardNo, mpm.Axis,
        ...
        public int GetCardAxisAlarmState(int CardNo, int axis)
        {
            ...
            int errcode = SLD1232SDK.Instance.GetCardAxisIOStatus(CardNo, axis);
            return errcode;
        }
        ...
        public double GetCardAxisCurrentPosition(int cntr_no)
        {
            ...
            if (cntr_no == 0)
            {
                pos = SLD1232SDK.Instance.GetCardAxisPosition(AxisWhichCardNo, AxisID);
            }
            else
            {
                pos = SLD1232SDK.Instance.GetCardAxisEncoder(AxisWhichCardNo, AxisID);
            }
            return pos;
        }
        ...
        public int GetCardAxisCurrentState()
        {
            ...
            int Axis_StateMachine = SLD1232SDK.Instance.GetCardAxisCheckDone(AxisWhichCardNo, AxisID);
        ...
        public int GetCardAxisELLimit()
        {
            ...
            return SLD1232SDK.Instance.GetCardAxisELMode(AxisWhichCardNo, AxisID, ref el_enable, ref el_logic, ref el_mode);
        }
        /// <summary>
        /// 获取轴的高速回零减速度
        /// </summary>
        ...
        public int GetCardAxisHomeMode()
        {
            ...
            if (SLD1232SDK.Instance.GetCardAxisHomeMode(AxisWhichCardNo, AxisID, ref home_dir, ref vel, ref mode, ref EZ_count) == 1)
            {
                return mode;
            }
            return -1;
        ...
        public int GetCardAxisInitVel(ref int pSpeed)
        {
            ...
            double pspeed = 0;
            int result = 0;
            pspeed = SLD1232SDK.Instance.GetCardAxisCurrentSpeed(AxisWhichCardNo, AxisID);
            result = (int)pspeed;
            return result;
        }
        /// <summary>
        ...
        {
            return SLD1232SDK.Instance.GetCardAxisPosition(card, axis);
        }
        /// <summary>
        /// 读取轴的反向回零距离
        /// </summary>
        ...
        public LimitParamModel GetCardAxisSoftLimit(LimitParamModel lpm)
        {
            ...
            int N_limit = 0;
            int P_limit = 0;
            SLD1232SDK.Instance.GetCardAxisSoftLimit(lpm.CardNo, lpm.Axis, ref enable, ref source_sel, ref SL_action, ref N_limit, ref P_limit);
            lpm.Enable = enable;
        ...
        {
            var res = SLD1232SDK.Instance.GetErrorInfo(ErrNum);
            return res;
        }
        ...
        {
            return SLD1232SDK.Instance.AddCardAxisComparePoint((ushort)CardNo, (ushort)axis, pos, (ushort)dir, action, actpara);
        }
        ...
        {
            //int ptNum = 0;
            return SLD1232SDK.Instance.GetCardAxisComparePointsRunned(CardNo, axis, ref pointNum);
        }
        ...
        {
            return SLD1232SDK.Instance.ClearCardAxisComparePoints((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return SLD1232SDK.Instance.GetCardAxisCompareConfig(CardNo, axis, ref enable, ref cmp_source);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisCompareConfig(CardNo, axis, enable, cmp_source);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisHcmpConfig(CardNo, hcmp, axis, cmp_source, cmp_logic, (int)time);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisPosition(CardNo, axis, pos);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisEncoder(CardNo, axis, encoder_value);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisELMode(lpm.CardNo, lpm.Axis, (ushort)lpm.Enable, (ushort)lpm.Plimit, (ushort)lpm.SLAction);
        }
        ...
        {
            return SLD1232SDK.Instance.CardAxisStop(AxisWhichCardNo, axis, stop_mode);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisHomeMode(hpm.CardNo, hpm.Axis, hpm.HomeDir, /*hpm.HomeSpeed*/hpm.Vel,
        ...
        public int SetCardAxisHomeElReturn(int CardNo, int axis, ushort enable)
        {
            ...
            位回零方式起作用。
             */
            return SLD1232SDK.Instance.SetCardAxisHomeElReturn((ushort)CardNo, (ushort)axis, enable);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardVectorProfileMulticoor(mpm.CardNo, mpm.Axis,
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisPosition(CardNo, axis, equiv); ;
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisSoftLimit(lpm.CardNo, lpm.Axis, (ushort)lpm.Enable, (ushort)lpm.SourceSel, (ushort)lpm.SLAction, lpm.Nlimit, lpm.Plimit);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisSProfile(mpm.CardNo, mpm.Axis, mpm.SMode, mpm.SPara);
        }
        ...
        {
            return SLD1232SDK.Instance.GetCardAxisProfile(CardNo, axis,ref Min_Vel,ref Max_Vel,ref Tacc,ref Tdec,ref stop_vel);
        }
        ...
        {
            return SLD1232SDK.Instance.GetCardAxisSProfile(CardNo, axis, s_mode, ref s_para);
        }
        ...
        {
            return SLD1232SDK.Instance.GetCardAxisSevonPin(AxisWhichCardNo, AxisID);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisInpMode(CardNo, axis, enable, inp_logic);
        }
        ...
        {
            return SLD1232SDK.Instance.CardAxisWriteSevonPin(AxisWhichCardNo, AxisID, on_off);
        }
        ...
        public int SetCardAxisTProfile(MotionParamModel mpm)
        {
            lock (dmc3000apilock)
            {
                ...
                return SLD1232SDK.Instance.SetCardAxisProfile(mpm.CardNo, mpm.Axis, mpm.MinVel, mpm.MaxVel, mpm.TaccVel,mpm.TdecVel,mpm.StopVel);
            }
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardDebugMode(CardNo, FileName);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardCompareConfigExtern(CardNo, enable, cmp_source);
        }
        ...
        public int SetCardHcmpEnable(int CardNo, int axis, int hcmp, int cmp_mode = 0)
        {
            ...
            return SLD1232SDK.Instance.SetCardAxisHcmpMode(CardNo, hcmp, cmp_mode);
        ...
        {
            return SLD1232SDK.Instance.GetCardAxisLatchValueExtern(CardNo, axis,Index);
        }
        /// <summary>
        /// 从 PC 缓存中读取锁存器已锁存个数
        /// </summary>
        ...
        {
            return SLD1232SDK.Instance.GetCardAxisLatchFlagExtern((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisHcmpConfig((ushort)CardNo, (ushort)hcmp, (ushort)axis, (ushort)cmp_source, (ushort)cmp_logic, time);
        }
        /// <summary>
        /// 设置高速比较线性模式参数    
        /// </summary>
        ...
        {
            return SLD1232SDK.Instance.SetCardHcmpLiner((ushort)CardNo, (ushort)hcmp, Increment, Count);
        }
        /// <summary>
        /// 添加/更新高速比较位置
        /// </summary>
        ...
        {
            return SLD1232SDK.Instance.AddCardHcmpPoint((ushort)CardNo, (ushort)hcmp, cmp_pos);
        }

        public int SetCardAxisLatchMode(int CardNo, int axis, int all_enable, int latch_source, int triger_chunnel)
        {
            return SLD1232SDK.Instance.SetCardAxisLatchMode((ushort)CardNo, (ushort)axis, (ushort)all_enable, (ushort)latch_source, (ushort)triger_chunnel);
        }
        /// <summary>
        /// 设置指定轴的 LTC 信号
        /// </summary>
        ...
        {
            return SLD1232SDK.Instance.SetCardAxisLtcMode((ushort)CardNo, (ushort)axis,ltc_logic, ltc_mode, filter);
        }
        ...
        {
            return SLD1232SDK.Instance.GetCardAxisLatchValue((ushort)CardNo, (ushort)axis);
        }
        /// <summary>
        /// 从控制卡内读取指定卡内锁存器的标志位
        /// </summary>
        ...
        {
            return SLD1232SDK.Instance.GetCardAxisLatchFlag((ushort)CardNo, (ushort)axis);
        }
        public int SetCardHcmpCmpPin(int CardNo, int hcmp, int on_off)
        {
            return SLD1232SDK.Instance.SetCardHcmpCmpPin((ushort)CardNo, (ushort)hcmp, (ushort)on_off);
        }
        /// <summary>
        /// 读取指定 CMP 端口的电平
        /// </summary>
        ...
        {
            return SLD1232SDK.Instance.GetCardHcmpCmpPin((ushort)CardNo, (ushort)hcmp);
        }
        /// <summary>
        /// 复位指定卡的锁存器的标志位
        /// </summary>
        ...
        {
            return SLD1232SDK.Instance.GetCardAxisReserLatchFlag((ushort)CardNo, (ushort)axis);
        }
        /// <summary>
        /// 设置轴的螺距补偿
        /// </summary>
        ...
        {
            return SLD1232SDK.Instance.GetCardHcmpCurrentState((ushort)CardNo, (ushort)hcmp, ref remained_points, ref current_point, ref runned_points);
        ...
        {
            return SLD1232SDK.Instance.CardAxisStop(CardNo, axis, stop_mode);
        }
        ...
        public int SetStatusParameter(int axis, bool f, AxisStatusParameterEnum kind)
        {
            ...
            if (kind.ToString() == "正限位" || kind.ToString() == "负限位")
            {
                if (f == true)
                {
                    res = SLD1232SDK.Instance.SetCardAxisELMode(AxisWhichCardNo,axis,1,1,0);
                }
                else
                {
                    res = SLD1232SDK.Instance.SetCardAxisELMode(AxisWhichCardNo, axis, 1, 0, 0);
                }
            }
            if (kind.ToString() == "原点位")
            {
                if (f == true)
                {
                    res = SLD1232SDK.Instance.SetCardAxisHomePinLogic(AxisWhichCardNo, axis, 1, 0);
                }
                else
                {
                    res = SLD1232SDK.Instance.SetCardAxisHomePinLogic(AxisWhichCardNo, axis, 0, 0);
                }
            }
            if (kind.ToString() == "急停")
            {
                if (f == true)
                {
                    res = SLD1232SDK.Instance.SetCardAxisEmgMode(AxisWhichCardNo, axis,1, 1);
                }
                else
                {
                    res = SLD1232SDK.Instance.SetCardAxisEmgMode(AxisWhichCardNo, axis, 1, 0);
                }
            }
            if (kind.ToString() == "报警")
            {
                if (f == true)
                {
                    res = SLD1232SDK.Instance.SetCardAxisAlmMode(AxisWhichCardNo, axis, 1, 1,0);
                }
                else
                {
                    res = SLD1232SDK.Instance.SetCardAxisAlmMode(AxisWhichCardNo, axis, 1, 0,0);
                }
            }
