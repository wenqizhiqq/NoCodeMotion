...
//   源: MotionCardRes/SLD1232/InioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.SLD1232
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            return SLD1232SDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return (int)SLD1232SDK.Instance.GetCardInBit(CardNo, portno);
        }
        ...
        public uint GetCardCANIOInPort(int CardNo, int NodeID, int PortNo, ref UInt32 IoValue)
        {
            uint IoValue1 = 0;
            // PortNo = 0;
            SLD1232SDK.Instance.GetCard_CANIO_InPort(CardNo, NodeID, PortNo, ref IoValue1);
        ...
        {
            return (int)SLD1232SDK.Instance.GetCardInPort(CardNo, portno);
        }
