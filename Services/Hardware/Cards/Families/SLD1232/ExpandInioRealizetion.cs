...
//   源: MotionCardRes/SLD1232/ExpandInioRealizetion.cs
...
namespace Samsun.Domain.MotionCard.Common.SLD1232
{
    public class ExpandInioRealizetion : IEIOInPut
    {
        ...
        {
            return SLD1232SDK.Instance.GetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo,ref mode);
        }
        ...
        {
            return SLD1232SDK.Instance.GetExpandADDAIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return SLD1232SDK.Instance.GetExpandIOInBit(CardNo, NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return SLD1232SDK.Instance.GetExpandIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return SLD1232SDK.Instance.SetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo, mode);
        }
