...
//   源: MotionCardRes/SLD1230/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.SLD1230
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return SLD1230SDK.Instance.GetCardOutPort(CardNo, portno);
        }
        ...
        {
            uint IoValue1 = 0;
            SLD1230SDK.Instance.GetCard_CANIO_OutPort(CardNo, NodeID, PortNo, ref IoValue1);
            return IoValue1;
        }
        ...
        {
            return SLD1230SDK.Instance.GetCardOutBit(CardNo, bitno);
        }
        ...
        public int SetCardBitNoInBit(int CardNo, int bitno, int on_off)
        {
            ...
            return SLD1230SDK.Instance.SetCardWriteOutBit(CardNo, bitno, on_off);
        }
        ...
        public int SetCardCANIOOutBit(int CardNo, int NodeID, int IoBit, int IoValue)
        {
            //IoBit = 0;
            //IoValue = 1;
            return SLD1230SDK.Instance.SetCard_CANIO_OutBit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, (ushort)IoValue);
        }
        ...
        {
            return SLD1230SDK.Instance.SetCardOutPort(CardNo, portno, outport_val);
        }
