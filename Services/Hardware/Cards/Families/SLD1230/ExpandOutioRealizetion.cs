...
//   源: MotionCardRes/SLD1230/ExpandOutioRealizetion.cs
...
namespace Samsun.Domain.MotionCard.Common.SLD1230
{
    ...
    public class ExpandOutioRealizetion : IEIOOutPut
    {
        ...
        {
            return SLD1230SDK.Instance.SetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, mode, buffer_nums);
        }
        ...
        {
            return SLD1230SDK.Instance.GetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, ref mode, buffer_nums);
        }
        ...
        {
            return SLD1230SDK.Instance.GetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return SLD1230SDK.Instance.GetExpandIOOutBit(CardNo,  NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return SLD1230SDK.Instance.GetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return SLD1230SDK.Instance.SetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo,  IoValue);
        }
        ...
        {
            return SLD1230SDK.Instance.SetExpandIOOutBit(CardNo, NodeID, IoBit, IoValue);
        }
        ...
        {
            return SLD1230SDK.Instance.SetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, IoValue);
        }
