...
//   源: MotionCardRes/SLD1230/SLD1230SDK.cs
...
{
    public class SLD1230SDK
    {
        public bool IsInit { get; set; }

        private static readonly Lazy<SLD1230SDK> lazy = new Lazy<SLD1230SDK>(() => new SLD1230SDK());
        public static SLD1230SDK Instance { get { return lazy.Value; } }
        ...
        public int InitBoardCard()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                if (CPcie1230.Pci1230Open(i) == CPcie1230.PCI1230Success)
                {
        ...
        {
            return 0;
            //return CPcie1230.dmc_board_reset();
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_soft_reset(CardNo);
        }
        ...
        public int GetCardInfList(ref UInt16 CardNum, ref UInt32[] CardTypeList, ref UInt16[] CardIdList)
        {
            ...
            for (int i = 0; i < CardIDList.Count; i++)
            {
                ...
                CardTypeList[i] = 0x1230;
            }
            return 0;
            //return CPcie1230.dmc_get_CardInfList(ref CardNum, CardTypeList, CardIdList);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_vector_profile_multicoor(cardNo, crd, 0, maxVel, tacc, 0, 0);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_card_version((ushort)CardNo, ref CardVersion);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_card_soft_version((ushort)CardNo, ref FirmID, ref SubFirmID);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_card_lib_version(ref LibVer);
        }
        ...
        public int GetCardTotalAxisNum(int CardNo, ref UInt32 TotalAxis)
        {
            TotalAxis = 0;
            return 0;
            //return CPcie1230.dmc_get_total_axes((ushort)CardNo, ref TotalAxis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_download_configfile((ushort)CardNo, FileName);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_download_firmware((ushort)CardNo, FileName);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_pulse_outmode((ushort)CardNo, (ushort)axis, (ushort)outmode);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_pulse_outmode((ushort)CardNo, (ushort)axis, ref outmode);
        }
        #endregion
        ...
        public int SetCardAxisHomeElReturn(int CardNo, int axis, ushort enable)
        {
             ...
             */
            return 0;
            //return CPcie1230.dmc_set_home_el_return((ushort)CardNo, (ushort)axis, enable);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_home_pin_logic((ushort)CardNo, (ushort)axis, (ushort)org_logic, filter);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_home_pin_logic((ushort)CardNo, (ushort)axis, ref org_logic, ref filter);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_homemode((ushort)CardNo, (ushort)axis, (ushort)home_dir, vel, (ushort)mode, (ushort)EZ_count);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_homemode((ushort)CardNo, (ushort)axis, ref home_dir, ref vel, ref mode, ref EZ_count);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_home_move((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_home_result((ushort)CardNo, (ushort)axis, ref status);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_homelatch_mode((ushort)CardNo, (ushort)axis, enable, logic, source);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_homelatch_mode((ushort)CardNo, (ushort)axis, ref enable, ref logic, ref source);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_reset_homelatch_flag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_homelatch_flag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_homelatch_value((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_el_mode((ushort)CardNo, (ushort)axis, el_enable, el_logic, el_mode);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_el_mode((ushort)CardNo, (ushort)axis, ref el_enable, ref el_logic, ref el_mode);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_softlimit((ushort)CardNo, (ushort)axis, enable, source_sel, SL_action, N_limit, P_limit);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_softlimit((ushort)CardNo, (ushort)axis, ref enable, ref source_sel, ref SL_action, ref N_limit, ref P_limit);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_position((ushort)CardNO, (ushort)axis, current_position);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_position((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_read_current_speed((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_LinkState((ushort)CardNo, ref State);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_check_done((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_check_done_multicoor((ushort)CardNo, (ushort)crd);
        }
        ...
        {
            return 0;
            //return (int)CPcie1230.dmc_axis_io_status((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return (int)CPcie1230.dmc_stop((ushort)CardNo, (ushort)axis, (ushort)stop_mode);
        }
        ...
        {
            return 0;
            //return (int)CPcie1230.dmc_stop_multicoor((ushort)CardNo, (ushort)crd, (ushort)stop_mode);
        }
        ...
        {
            return 0;
            //return (int)CPcie1230.dmc_emg_stop((ushort)CardNo);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_profile((ushort)CardNo, (ushort)axis, Min_Vel, Max_Vel, Tacc, Tdec, stop_vel);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_profile((ushort)CardNo, (ushort)axis, ref Min_Vel, ref Max_Vel, ref Tacc, ref Tdec, ref stop_vel);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_s_profile((ushort)CardNo, (ushort)axis, (ushort)s_mode, s_para);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_s_profile((ushort)CardNo, (ushort)axis, (ushort)s_mode, ref s_para);
        }
        #endregion
        ...
        {
            return 0;
            //return CPcie1230.dmc_pmove((ushort)CardNo, (ushort)axis, Dist, (ushort)posi_mode);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_vmove((ushort)CardNo, (ushort)axis, (ushort)dir);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_change_speed((ushort)CardNo, (ushort)axis, Curr_Vel, Taccdec);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_reset_target_position((ushort)CardNo, (ushort)axis, dist, (ushort)posi_mode);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_update_target_position((ushort)CardNo, (ushort)axis, dist, (ushort)posi_mode);
        }
        #endregion
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_vector_profile_multicoor((ushort)CardNo, (ushort)Crd, Min_Vel, Max_Vel, Tacc, Tdec, Stop_Vel);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_vector_profile_multicoor((ushort)CardNo, (ushort)Crd, ref Min_Vel, ref Max_Vel, ref Tacc, ref Tdec, ref Stop_Vel);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_line_multicoor((ushort)CardNo, (ushort)Crd, (ushort)axisNum, axisList, DistList, (ushort)posi_mode);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_arc_move_multicoor((ushort)CardNo, (ushort)Crd, AxisList, Target_Pos, Cen_Pos, (ushort)Arc_Dir, (ushort)posi_mode);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_PttTable((ushort)CardNo, (ushort)axis, count, pTime, pPos);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_PtsTable((ushort)CardNo, (ushort)axis, count, pTime, pPos, pPercent);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_PvtTable((ushort)CardNo, (ushort)axis, count, pTime, pPos, pVel);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_PvtsTable((ushort)CardNo, (ushort)axis, count, pTime, pPos, velBegin, velEnd);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_PvtMove((ushort)CardNo, (ushort)axisnum, AxisList);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_write_sevon_pin((ushort)CardNo, (ushort)axis, (ushort)on_off);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_read_sevon_pin((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_read_rdy_pin((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_inp_mode((ushort)CardNo, (ushort)axis, (ushort)enable, (ushort)inp_logic);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_inp_mode((ushort)CardNo, (ushort)axis, ref enable, ref inp_logic);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_alm_mode((ushort)CardNo, (ushort)axis, (ushort)enable, (ushort)alm_logic, (ushort)alm_action);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_alm_mode((ushort)CardNo, (ushort)axis, ref enable, ref alm_logic, ref alm_action);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_write_erc_pin((ushort)CardNo, (ushort)axis, (ushort)sel);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_read_erc_pin((ushort)CardNo, (ushort)axis);
        }
        ...
        public int GetCardInBit(int CardNo, int bitno)
        {
            ...
            //var d2 = bitno % 32;
            uint data = 1;
            if (CPcie1230.PCI1230Success == CPcie1230.Pci1230ReadDiBit(CardNo, bitno, ref data))
            {
               var resdata = (data == 0 ? 1 : 0);
                return (int)resdata;
            }
            return 2;
        }
        ...
        public int SetCardWriteOutBit(int CardNo, int bitno, int on_off)
        {
            ...
            if (CPcie1230.PCI1230Success == CPcie1230.Pci1230WriteDoBit(CardNo, bitno, (ushort)res))
            {
                return 0;
            }
            return 1;
        ...
        public int GetCardOutBit(int CardNo, int bitno)
        {
            ...
            //var d2 = bitno % 32;
            uint data = 2;
            if (CPcie1230.PCI1230Success == CPcie1230.Pci1230ReadDoBit(CardNo, bitno, ref data))
            {
        ...
        public uint GetCardInPort(int CardNo, int portno)
        {
            uint data = 0;
            //CardNo = 7;
            if (CPcie1230.PCI1230Success == CPcie1230.Pci1230Read(CardNo, ref data))
            {
                //data = 1;
        ...
        public uint GetCardOutPort(int CardNo, int portno)
        {
            ...
            {
                uint data = 1;
                if (CPcie1230.PCI1230Success != CPcie1230.Pci1230ReadDoBit(CardNo, i, ref data))
                    return 0;
            ...
            //return CPcie1230.dmc_read_outport((ushort)CardNo, (ushort)portno);
        }
        ...
        public int SetCardOutPort(int CardNo, int portno, uint outport_val)
        {
            ...
            #endregion
            //var res = CPcie1230.Pci1230Write((ushort)CardNo, outport_val);
            var res = CPcie1230.Pci1230Write((ushort)CardNo, value);

            if (CPcie1230.PCI1230Success == res)
            {
                return 0;
            }
            else if (CPcie1230.PCI1230ApiFailed == res)
            {
                return 1;
            }
            else if (CPcie1230.PCI1230InvalidParam == res)
            {
                return 2;
            }
            else
        ...
        {
            return 0;
            //return CPcie1230.dmc_reverse_outbit((ushort)CardNo, (ushort)bitno, reverse_time);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_io_count_mode((ushort)CardNo, (ushort)bitno, (ushort)mode, filter_time);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_io_count_mode((ushort)CardNo, (ushort)bitno, ref mode, ref filter_time);
        }
        /// <summary>
        /// 设置 IO 计数值
        /// </summary>
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_io_count_value((ushort)CardNo, (ushort)bitno, (uint)CountValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_io_count_value((ushort)CardNo, (ushort)bitno, ref CountValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_handwheel_inmode((ushort)CardNo, (ushort)axis, (ushort)inmode, multi, vh);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_handwheel_inmode((ushort)CardNo, (ushort)axis, ref inmode, ref multi, ref vh);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_handwheel_move((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_handwheel_channel((ushort)CardNo, (ushort)index);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_handwheel_channel((ushort)CardNo, ref index);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_handwheel_inmode_extern((ushort)CardNo, inmode, AxisNum, AxisList, multi);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_handwheel_inmode_extern((ushort)CardNo, ref inmode, ref AxisNum, AxisList, multi);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_counter_inmode((ushort)CardNo, (ushort)axis, (ushort)mode);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_counter_inmode((ushort)CardNo, (ushort)axis, ref mode);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_encoder((ushort)CardNo, (ushort)axis, encoder_value);
        }
        /// <summary>
        /// 获取指定轴编码器脉冲计数值
        /// <para>说 明：</para>
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_encoder((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_ez_mode((ushort)CardNo, (ushort)axis, (ushort)ez_logic, (ushort)ez_mode, filter);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_ez_mode((ushort)CardNo, (ushort)axis, ref ez_logic, ref ez_mode, ref filter);
        }
        #endregion
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_ltc_mode((ushort)CardNo, (ushort)axis, ltc_logic, ltc_mode, filter);
        }
        public int SetCardAxisLatchMode(int CardNo, int axis, int all_enable, int latch_source, int triger_chunnel)
        {
            return 0;
            //return CPcie1230.dmc_set_latch_mode((ushort)CardNo, (ushort)axis, (ushort)all_enable, (ushort)latch_source, (ushort)triger_chunnel);
        }
        /// <summary>
        /// 获取指定轴的 LTC 信号设置
        /// </summary>
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_ltc_mode((ushort)CardNo, (ushort)axis, ref ltc_logic, ref ltc_mode, ref filter);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_latch_mode((ushort)CardNo, (ushort)axis, all_enable, latch_source, triger_chunnel);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_latch_mode((ushort)CardNo, (ushort)axis, ref all_enable, ref latch_source, ref triger_chunnel);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_latch_stop_time((ushort)CardNo, (ushort)axis, time);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_latch_stop_time((ushort)CardNo, (ushort)axis, ref time);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_SetLtcOutMode((ushort)CardNo, (ushort)axis, (ushort)enable, (ushort)bitno);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_GetLtcOutMode((ushort)CardNo, (ushort)axis, ref enable, ref bitno);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_latch_value((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_latch_flag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_reset_latch_flag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_latch_flag_extern((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_latch_value_extern((ushort)CardNo, (ushort)axis, (ushort)Index);
        }
        ...
        public int SetCardAxisHcmp2dsetEnable(int CardNo, int hcmp, int cmpEnable)
        {
            ...
            return 0;
            //return CPcie1230.dmc_hcmp_2d_set_enable((ushort)CardNo, (ushort)hcmp, (ushort)cmpEnable);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_set_config((ushort)CardNo, (ushort)axis, (ushort)enable, (ushort)cmp_source);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_get_config((ushort)CardNo, (ushort)axis, ref enable, ref cmp_source);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_clear_points((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_add_point((ushort)CardNo, (ushort)axis, pos, (ushort)dir, action, actpara);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_get_current_point((ushort)CardNo, (ushort)axis, ref pos);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_get_points_runned((ushort)CardNo, (ushort)axis, ref pointNum);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_get_points_remained((ushort)CardNo, (ushort)axis, ref pointNum);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_set_config_extern((ushort)CardNo, (ushort)enable, (ushort)cmp_source);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_get_config_extern((ushort)CardNo, ref enable, ref cmp_source);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_clear_points_extern((ushort)CardNo);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_add_point_extern((ushort)CardNo, axis, pos, dir, action, actpara);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_get_current_point_extern((ushort)CardNo, pos);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_get_points_runned_extern((ushort)CardNo, ref pointNum);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_compare_get_points_remained_extern((ushort)CardNo, ref pointNum);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_hcmp_set_mode((ushort)CardNo, (ushort)hcmp, (ushort)cmp_enable);
        }
        /// <summary>
        /// 清除已添加的所有高速位置比较点
        /// </summary>
        ...
        {
            return 0;
            //return CPcie1230.dmc_hcmp_clear_points((ushort)CardNo, (ushort)hcmp);
        }
        /// <summary>
        ///读取高速比较模式设置
        /// </summary>
        ...
        {
            return 0;
            //return CPcie1230.dmc_hcmp_get_mode((ushort)CardNo, (ushort)hcmp, ref cmp_enable);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_hcmp_set_config((ushort)CardNo, (ushort)hcmp, (ushort)axis, (ushort)cmp_source, (ushort)cmp_logic, time);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_hcmp_get_config((ushort)CardNo, (ushort)hcmp, ref axis, ref cmp_source, ref cmp_logic, ref time);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_hcmp_add_point((ushort)CardNo, (ushort)hcmp, cmp_pos);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_hcmp_set_liner((ushort)CardNo, (ushort)hcmp, Increment, Count);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_hcmp_get_liner((ushort)CardNo, (ushort)hcmp, ref Increment, ref Count);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_hcmp_get_current_state((ushort)CardNo, (ushort)hcmp, ref remained_points, ref current_point, ref runned_points);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_write_cmp_pin((ushort)CardNo, (ushort)hcmp, (ushort)on_off);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_read_cmp_pin((ushort)CardNo, (ushort)hcmp);
        }
        #endregion
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_emg_mode((ushort)CardNo, (ushort)axis, (ushort)enable, (ushort)emg_logic);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_emg_mode((ushort)CardNo, (ushort)axis, ref enable, ref emg_logic);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_io_dstp_mode((ushort)CardNo, (ushort)axis, (ushort)enable, (ushort)logic);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_io_dstp_mode((ushort)CardNo, (ushort)axis, ref enable, ref logic);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_dec_stop_time((ushort)CardNo, (ushort)axis, stop_time);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_dec_stop_time((ushort)CardNo, (ushort)axis, ref stop_time);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_axis_io_map((ushort)CardNo, (ushort)axis, (ushort)IoType, (ushort)MapIoType, (ushort)MapIoIndex, Filter);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_axis_io_map((ushort)CardNo, (ushort)axis, (ushort)IoType, ref MapIoType, ref MapIoIndex, ref Filter);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_special_input_filter((ushort)CardNo, Filter);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_io_map_virtual((ushort)CardNo, (ushort)bitno, (ushort)MapIoType, (ushort)MapIoIndex, Filter);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_io_map_virtual((ushort)CardNo, (ushort)bitno, ref MapIoType, ref MapIoIndex, ref filter_time);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_read_inbit_virtual((ushort)CardNo, (ushort)bitno);
        }
        #endregion
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_factor_error((ushort)CardNo, (ushort)axis, factor, error);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_factor_error((ushort)CardNo, (ushort)axis, ref factor, ref error);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_check_success_pulse((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_check_success_encoder((ushort)CardNo, (ushort)axis);
        }
        ...
        //{
        //    return CPcie1230.nmc_set_connect_state((ushort)CardNo, (ushort)NodeNum, (ushort)state, (ushort)baud);
        //}
        ...
        {
            return 0;
            //return CPcie1230.nmc_get_connect_state((ushort)CardNo, ref NodeNum, ref state);
        }
        /// <summary>
        ...
        {
            return 0;
            //return CPcie1230.nmc_write_outbit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, (ushort)IoValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_read_outbit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, ref IoValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_read_inbit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, ref IoValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_write_outport((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, (uint)IoValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_read_outport((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, ref IoValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_read_inport((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, ref IoValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_da_enable((ushort)CardNo, (ushort)enable);
        }
        /// <summary>
        /// 读取 DA 输出使能设置
        /// </summary>
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_da_enable((ushort)CardNo, ref enable);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_da_output((ushort)CardNo, (ushort)channel, Vout);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_da_output((ushort)CardNo, (ushort)channel, ref Vout);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_ad_input((ushort)CardNo, (ushort)channel, ref Vout);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_write_sn((ushort)CardNo, new_sn);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_check_sn((ushort)CardNo, check_sn);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_set_debug_mode((ushort)CardNo, FileName);
        }
        ...
        {
            return 0;
            //return CPcie1230.dmc_get_debug_mode(ref mode, FileName);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_write_outport((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, (ushort)IoValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_set_da_output((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, IoValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_get_da_output((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, ref IoValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_set_da_mode((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, (ushort)mode, buffer_nums);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_get_da_mode((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, ref mode, buffer_nums);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_get_ad_input((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, ref IoValue);
        }
        ...
        {
            return 0;
            //return CPcie1230.nmc_set_ad_mode((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, (ushort)mode, buffer_nums);
        ...
        {
            return 0;
            //return CPcie1230.nmc_get_ad_mode((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, ref mode, buffer_nums);
        ...
        {
            return 0;
            //return CPcie1230.nmc_write_to_flash((ushort)CardNo, (ushort)PortNum, (ushort)NodeNum);
        }
