...
//   源: MotionCardRes/SLD1230/InioRealization.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.SLD1230
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            return SLD1230SDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return (int)SLD1230SDK.Instance.GetCardInBit(CardNo, portno);
        }
        ...
        public uint GetCardCANIOInPort(int CardNo, int NodeID, int PortNo, ref UInt32 IoValue)
        {
            uint IoValue1 = 0;
            // PortNo = 0;
            SLD1230SDK.Instance.GetCard_CANIO_InPort(CardNo, NodeID, PortNo, ref IoValue1);
        ...
        {
            return (int)SLD1230SDK.Instance.GetCardInPort(CardNo, portno);
        }
