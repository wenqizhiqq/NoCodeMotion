...
//   源: MotionCardRes/YMCC1200P/YKMCC1200PSDK.cs
...
namespace Samsun.Domain.MotionCard.Common.YKMCC1200P
{
    public class YKMCC1200PSDK
    {
        public bool IsInit { get; set; }

        private static YKMCC1200PSDK _instance;
        public static YKMCC1200PSDK Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new YKMCC1200PSDK();
                return YKMCC1200PSDK._instance;
            }
            set { YKMCC1200PSDK._instance = value; }
        }
        ...
        {
            uint v1=0, v2=0;
            MCC1600.YK_get_card_soft_version(CardNum, ref v1, ref v2);
        ...
        {
            return MCC1600.YK_read_inport((ushort)CardNo, (ushort)portno);
        }
        ...
        {
            return MCC1600.YK_read_outport((ushort)CardNo, (ushort)portno);
        }
        ...
        {
            return MCC1600.YK_write_outport((ushort)CardNo, (ushort)portno, outport_val);
        }
