...
//   源: MotionCardRes/YMCC1200P/ExpandInioRealizetion.cs
...
namespace Samsun.Domain.MotionCard.Common.YKMCC1200P
{
    public class ExpandInioRealizetion : IEIOInPut
    {
        ...
        {
            return YKMCC1200PSDK.Instance.GetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo,ref mode);
        }
        ...
        {
            return YKMCC1200PSDK.Instance.GetExpandADDAIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC1200PSDK.Instance.GetExpandIOInBit(CardNo, NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return YKMCC1200PSDK.Instance.GetExpandIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC1200PSDK.Instance.SetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo, mode);
        }
