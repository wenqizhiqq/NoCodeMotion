...
//   源: MotionCardRes/EC600/InioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.EC600_EtherCAT
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            return EC600SDK.Instance.DmcGetCardPortNoInPort(CardNo, portno);
        }
        ...
        {
            return EC600SDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return EC600SDK.Instance.DmcGetCardInPortNoBit(CardNo, bitno);
        }
        ...
        {
            return EC600SDK.Instance.NmcReadInportExtern(CardNo, Channel, NoteID, PortNo, ref IoValue);
        }
        ...
        {
            short value = 0;
            int error = EC600SDK.Instance.NmcReadInbitExtern(CardNo, Channel, NoteID, IoBit, ref value);
