...
//   源: MotionCardRes/EC600/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.EC600_EtherCAT
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return EC600SDK.Instance.DmcSetCardBitNoInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return EC600SDK.Instance.DmcSetCardPortNoOutPort(CardNo, portno, (int)outport_val);
        }
        ...
        {
            return EC600SDK.Instance.DmcGetCardPortNoOutPort(CardNo, portno);
        }
        ...
        {
            return EC600SDK.Instance.DmcGetCardBitNoOutBit(CardNo, bitno);
        }
        ...
        {
            return EC600SDK.Instance.NmcReadOutportExtern(CardNo, Channel, NoteID, PortNo, ref IoValue);
        }


        public int NmcWriteOutbitExtern(int CardNo, int Channel, int NoteID, int IoBit, ushort IoValue)
        {
            return EC600SDK.Instance.NmcWriteOutbitExtern(CardNo, Channel, NoteID, IoBit, IoValue);
        }
        ...
        {
            return EC600SDK.Instance.NmcWriteOutportExtern(CardNo, Channel, NodeID, portno, Iovalue);
        }
        ...
        {
            short value = 0;
            int error = EC600SDK.Instance.NmcReadOutbitExtern(CardNo, Channel, NoteID, IoBit, ref value);
            IoValue = (ushort)value;
            return IoValue;
            //return 0;
        }
    }
