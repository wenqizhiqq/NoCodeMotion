...
//   源: MotionCardRes/MCN42Series/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.YKMCN42Series
{
    public class OutioRealization : IIOOutPut
    {
        ...
        /// 硬件卡拥有的输出IO的数量
        /// </summary>
        public ushort OutIONums { get; set; } = 24;
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardBitNoInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return (uint)YK_MCN42SeriesSDK.Instance.NmcReadOutportExtern(CardNo, 2, NodeID, PortNo, ref IoValue);
            return 0;
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardPortNoOutPort(CardNo, portno, outport_val);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcGetCardPortNoOutPort(CardNo, portno);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcGetCardBitNoOutBit(CardNo, bitno);
        }
        ...
        public int GetCardDOState(int CardNo, ref int pData)
        {
        ...
        {
            return YK_MCN42SeriesSDK.Instance.NmcReadOutportExtern(CardNo, Channel, NoteID, PortNo, ref IoValue);
        }


        public int NmcWriteOutbitExtern(int CardNo, int Channel, int NoteID, int IoBit, ushort IoValue)
        {
            return YK_MCN42SeriesSDK.Instance.NmcWriteOutbitExtern(CardNo, Channel, NoteID, IoBit, IoValue);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.NmcWriteOutportExtern(CardNo, Channel, NodeID, portno, Iovalue);
        }

        /// <summary>
        /// 获取输出端口的值 
        /// </summary>
        //public short GetCardOutBit()
        //{
        //    return 32767;
        //}
        ...
        {
            int error = YK_MCN42SeriesSDK.Instance.NmcReadOutbitExtern(CardNo, Channel, NoteID, IoBit, ref IoValue);
            return IoValue;
            //return 0;
        }
    }
