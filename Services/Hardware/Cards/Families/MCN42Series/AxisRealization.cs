...
//   源: MotionCardRes/MCN42Series/AxisRealization.cs
    ...
    public class AxisRealization : IAxis
    {
        ...
        public int AxisAlarm
        {
            get
            {
                ...
                var status = GetAxisCurrentState(0);
                if ((status & 1) == 1)
                {
                    return 1;
                }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcCardCrdStopMulticoor(CardNo, crd, stop_mode);//todo:2022.11.26
        }
        ...
        public int GetCardAxisInitVel(/*int CardNo,int Axis, */ref int pSpeed)
        {
            ...
            int result = YK_MCN42SeriesSDK.Instance.DmcGetCardAxisCurrentSpeedUnit(CarNo, AxisID, ref pspeed);
            pSpeed = (int)pspeed;
            return result;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public int GetAxisCurrentState(int type)
        {
            /*
            位号 信号名称 描述
            0 ALM 1：表示伺服报警信号 ALM 为 ON； 0：OFF
            ...
            3 EMG 1：表示急停信号 EMG 为 ON； 0：OFF
            4 ORG 1：表示原点信号 ORG 为 ON； 0：OFF
            5 INP 1：表示INP信号 INP 为 ON； 0：OFF
            6 SL+ 1：表示正软限位信号+SL 为 ON； 0：OFF
            7 SL- 1：表示负软件限位信号-SL 为 ON； 0：OFF
            8 Sevon 1：表示使能信号Sevon 为 ON； 0：OFF
            8 RDY 1：表示RDY信号RDY 为 ON； 0：OFF
            其他位 保
            */
            int status = 0;
            switch (type)
            {
                case 0: status = MCN420.YK_get_axis_alm_status((uint)this.AxisWhichCardNo, (uint)this.AxisID); break;
                case 1: status = MCN420.YK_get_axis_positive_limit_status((uint)this.AxisWhichCardNo, (uint)this.AxisID); break;
                case 2: status = MCN420.YK_get_axis_negative_limit_status((uint)this.AxisWhichCardNo, (uint)this.AxisID); break;
                case 3: status = MCN420.YK_get_emg_status((uint)this.AxisWhichCardNo); break;
                case 4: status = MCN420.YK_get_axis_home_status((uint)this.AxisWhichCardNo, (uint)this.AxisID); break;
        ...
        {
            var res = YK_MCN42SeriesSDK.Instance.GetErrorInfo(ErrNum);
            return res;
        }

        public string GetEtherCATErrorInfo(int ErrNum)
        {
            var res = YK_MCN42SeriesSDK.Instance.GetEtherCATErrorInfo(ErrNum);
            return res;
        }
        ...
        public int CardAxisArcMoveCenterUnit(ArcInterpolateparamModel arc)
        {
            ...
            return YK_MCN42SeriesSDK.Instance.DmcCardAxisArcMoveCenterUnit((ushort)arc.CardNo, (ushort)arc.Crd, (ushort)arc.Axis.Length, AxisNums, Target_Pos, Cen_Pos, (ushort)arc.ArcDir, arc.CircleCounts, (ushort)arc.PosiMode);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardVectorSProfile((ushort)CardNo, (ushort)Crd, 0, s_para, 1);
        }
        ...
        public int CardAxisContiArcMoveStart(ArcInterpolateparamModel arc)
        {
            ...
            YK_MCN42SeriesSDK.Instance.DmcCardAxisArcMoveRadiusUnit((ushort)arc.CardNo, (ushort)arc.Crd, (ushort)arc.Axis.Length, AxisNums, Target_Pos, arc.ArcRadius, (ushort)arc.ArcDir, arc.CircleCounts, (ushort)arc.PosiMode);
            return YK_MCN42SeriesSDK.Instance.DmcCardContiStartList(arc.CardNo, arc.Crd);//开启轴连续插补
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcCardContiStartList(line.CardNo, line.Crd);//开启轴连续插补
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcCardAxisHomeMove((ushort)AxisWhichCardNo, (ushort)AxisID);
        }
        ...
        public int CardAxisLineUnit(LineInterpolateparamModel line)
        {
            ...
            return YK_MCN42SeriesSDK.Instance.DmcCardAxisLineUnit(line.CardNo, line.Crd, line.Axis.Length, AxisNums, Target_Pos, line.PosiMode);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcCardAxisPMoveUnit(mpm.CardNo, mpm.Axis, mpm.Dist, (ushort)mpm.PosiMode);
        }
        ...
        public int CardAxesArcMoveCenterUnit(ArcInterpolateparamModel arc)
        {
            ...
            return YK_MCN42SeriesSDK.Instance.DmcCardArcMove3PointsUnit((ushort)arc.CardNo, (ushort)arc.Crd, (ushort)arc.Axis.Length, AxisNums, TargetPos, MidPos, arc.CircleCounts, (ushort)arc.PosiMode);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcCardAxisVMove(mpm.CardNo, mpm.Axis, mpm.Dir);
        }
        ...
        public int CardAxisWriteSevonPin(int on_off)
        {
            ...
            */
            ...
            if (on_off == 0)
            {
                res = YK_MCN42SeriesSDK.Instance.NmcSetCardAxisDisable(AxisWhichCardNo, AxisID);
            }
            else
            {
                res = YK_MCN42SeriesSDK.Instance.NmcSetCardAxisEnable(AxisWhichCardNo, AxisID);
            }
            return res;
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.NmcSetCardAxisDisable(CardNo, axis);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardContiLookaheadMode(impm.CardNo, impm.Crd, impm.Enable, impm.LookaheadSegments, impm.PathError, impm.LookaheadAcc);
        }
        ...
        public MotionParamModel GetCardAxisAccVel(MotionParamModel mpm)
        {
            ...
            YK_MCN42SeriesSDK.Instance.DmcGetCardAxisProfileUnit(mpm.CardNo, mpm.Axis,
        ...
        {
            ushort errcode = 0;
            YK_MCN42SeriesSDK.Instance.NmcGetCardAxisErrCode(CardNo, axis, ref errcode);
            return errcode;
        }
        ...
        {
            //double pos = 0;
            //YK_MCN42SeriesSDK.Instance.DmcGetCardAxisPositionUnit(AxisWhichCardNo, axis, ref pos);
            //return (int)pos;
            double pos = 0; //
            var res = 0;
            if (cntr_no == 0)
            {
                res = YK_MCN42SeriesSDK.Instance.DmcGetCardAxisPositionUnit(AxisWhichCardNo, AxisID, ref pos);
            }
            else
            {
                res = YK_MCN42SeriesSDK.Instance.DmcGetCardAxisEncoderUnit(AxisWhichCardNo, AxisID, ref pos);
            }
            if (res != 0)
            {
                return 0;
        ...
        public int GetCardAxisCurrentState(/*int CardNo, int axis*/)
        {
            ...
            var Axis_StateMachine = YK_MCN42SeriesSDK.Instance.DmcGetCardAxisCheckDone(AxisWhichCardNo, AxisID);
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisProfileUnit(mpm.CardNo, mpm.Axis,
        ...
        public HomeParameModel GetCardAxisHighHomeProfile(HomeParameModel hpm)
        {
            ...
            double Tdec = 0;
            double offsetpos = 0;
            YK_MCN42SeriesSDK.Instance.NmcGetCardAxisHomeProfile(hpm.CardNo, hpm.Axis, ref home_mode, ref Low_Vel, ref High_Vel, ref Tacc, ref Tdec, ref offsetpos);
        ...
        {
            double equiv = 0;
            YK_MCN42SeriesSDK.Instance.DmcGetCardAxisEquiv(CardNo, axis, ref equiv);
            return (int)equiv;
        }
        ...
        {
            UInt16 run_mode = 0;
            YK_MCN42SeriesSDK.Instance.DmcGetCardAxisRunMode(CardNo, axis, ref run_mode);
            return run_mode;
        }
        ...
        public LimitParamModel GetCardAxisSoftLimit(LimitParamModel lpm)
        {
            ...
            int N_limit = 0;
            int P_limit = 0;
            YK_MCN42SeriesSDK.Instance.DmcGetCardAxisSoftLimit(lpm.CardNo, lpm.Axis, ref enable, ref source_sel, ref SL_action, ref N_limit, ref P_limit);
            lpm.Enable = enable;
        ...
        {
            ushort errcode = 0;
            YK_MCN42SeriesSDK.Instance.NmcGetCardErrcode(CardNo, channel, ref errcode);
            return errcode;
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.NmcSetCardAxisEnable(CardNo, axis);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisCompareConfig(CardNo, axis, enable, cmp_source);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisPositionUnit(CardNo, axis, pos);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisHomeMode(hpm.CardNo, hpm.Axis, hpm.HomeDir, hpm.StartVel, hpm.Vel, hpm.HomeMode, hpm.TaccTime, hpm.TdecTime);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.NmcSetCardAxisHomeProfile(hpm.CardNo, hpm.Axis, hpm.HomeMode, hpm.LowVel, hpm.HighVel, hpm.TaccTime, hpm.TdecTime, hpm.EtherCATHomeOffset);
        }
        ...
        {//后续补充完成插补模式
            return YK_MCN42SeriesSDK.Instance.DmcSetCardVectorProfileUnit(imp.CardNo, imp.Crd, imp.MinVel, imp.MaxVel, imp.TaccTime, imp.TdecTime, imp.StopVel, 1);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.NmcSetCardAxisRunMode(CardNo, axis, runmode);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisSoftLimit(lpm.CardNo, lpm.Axis, lpm.Enable, lpm.SourceSel, lpm.SLAction, lpm.Nlimit, lpm.Plimit);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisSProfile(mpm.CardNo, mpm.Axis, mpm.SMode, mpm.SPara);
        }
        ...
        public int SetCardAxisTProfile(MotionParamModel mpm)
        {
            ...
            返回值：错误代码
             */
            return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisProfileUnit(mpm.CardNo, mpm.Axis, mpm.MinVel, mpm.MaxVel, mpm.TaccVel, mpm.TdecVel, mpm.StopVel);
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardCompareConfigExtern(CardNo, enable, cmp_source);
        }
        ...
        public int SetCardCompareConfigExternDate(PositionComparatorParamModel pcpm)
        {
            ...
            return YK_MCN42SeriesSDK.Instance.DmcAddCardComparePointsExtern(pcpm.CardNo, AxisNums, pcpm.XCmpPos, CmpMode, pcpm.Enable, pcpm.PortSel);
        }
        ...
        {
            //return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisCompareConfig(CardNo, axis, enable, cmp_source);
            return YK_MCN42SeriesSDK.Instance.DmcSetCardHcmpMode1(CardNo, enable, cmp_source);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardLeadScrewCompConfig(pcm.CardNo, pcm.Axis, pcm.n,
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardLeadScrewCompEnable(CardNo, axis, enable);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardContiLookaheadMode(CardNo, Crd, enable, LookaheadSegments, PathError, LookaheadAcc);
        }
        /// <summary>
        /// 设置减速轴停止时间
        /// </summary>
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisDecStopTime(CardNo, axis, stopTime);
        }
        ...
        {
            //YK_MCN42SeriesSDK.Instance.CardDmcEmgStop(CardNo);
            return YK_MCN42SeriesSDK.Instance.DmcCardAxisStop(CardNo, axis, stop_mode);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardVectorProfileUnit(AxisWhichCardNo,
                parameter.Crd, parameter.minVel, parameter.maxVel,
                parameter.tacc, parameter.tdec, parameter.stopVel, 1);
        }
        ...
        {
            //return 0;
            return YK_MCN42SeriesSDK.Instance.DmcClearCardAxisComparePoints(CardNo, hcmp);
        }
        ...
        {
            //return 0;
            return YK_MCN42SeriesSDK.Instance.DmcAddCardHcmpPoint(CardNo, hcmp, cmp_pos);
        }
        ...
        {
            return (int)YK_MCN42SeriesSDK.Instance.DmcGetCardLtcValueUnit(CardNo, axis);
            return 0;
        }
        ...
        /// <param name="ltc_logic">16种锁存模式</param>
        /// <param name="inputBit"> :锁存输入位 0-127</param>
        /// <param name="enable">使能锁存</param>
        /// 当锁存源选择：轴指令位置时，取值 0-31；当锁存源选择：轴编码器位置时，取值 0-31；当锁存源选择：辅助编码器位置时，取值 0-3；</param>
        /// <returns>错误代码</returns>
        public int SetCardAxisLtcMode(int CardNo, int axis, ushort ltc_logic, ushort inputBit, double enable)
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardLtcMode(CardNo, axis, (int)enable, inputBit, ltc_logic);
            return 0;
        }
        ...
        {
            //return YK_MCN42SeriesSDK.Instance.DmcSoftltcGetNumber()
            return 0;
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardDebugMode(CardNo, FileName);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisEncoderUnit(CardNo, axis, encoder_value);
        }
        ...
        {
            ushort status = 0;
            YK_MCN42SeriesSDK.Instance.NmcGetCardAxisStateMachine(AxisWhichCardNo, AxisID, ref status);
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcGetCardCrdCheckDoneMulticoor(CardNo, AxisID);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcCardAxisChangeSpeed(CardNo, axis, Curr_Vel, Taccdec);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisHcmpConfig(CardNo, hcmp, axis, cmp_source, cmp_logic, (int)time);
            //return YK_MCN42SeriesSDK.Instance.DmcSetCardAxisCompareConfig(CardNo, axis, 1, cmp_source);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcGetCardHomeResult(CardNo, axis, ref status);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcGetCardAxisProfileUnit(CardNo, axis, ref Min_Vel, ref Max_Vel, ref Tacc, ref Tdec, ref stop_vel);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcGetCardAxisSProfile(CardNo, axis, s_mode, ref s_para);
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcAddCardAxisComparePoints(CardNo, axis, pos, dir, action, (int)actpara);
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcClearCardAxisComparePoints((ushort)CardNo, (ushort)axis);
        ...
        public double GetCardAxisCurrentSpeed(int CardNo, int axis)
        {
            ...
            var res = YK_MCN42SeriesSDK.Instance.DmcGetCardAxisCurrentSpeedUnit(CardNo, axis, ref currentSpeed);
        ...
        public int Axis_Syslock_Output(int Channel, int enable, int input_bit, int lock_mode, int cmp_num, int[] cmp_channel, double[] cmp_pos)
        {
            YK_MCN42SeriesSDK.Instance.DmcSetCardLtcMode(AxisWhichCardNo, AxisID, Channel, enable, input_bit, lock_mode, (ushort)cmp_num, cmp_channel, cmp_pos);
            return 0;
        }
        ...
        {
            return YK_MCN42SeriesSDK.Instance.DmcCardAxisResetTargetPositionUnit(CardNo, axis, dist, posi_mode);
        }
