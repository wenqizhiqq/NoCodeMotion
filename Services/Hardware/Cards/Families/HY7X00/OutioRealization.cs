...
//   源: MotionCardRes/HY7X00/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.HY7X00
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return HY7X00SDK.Instance.GetCardOutPort(CardNo, portno);
        }
        ...
        {
            uint IoValue1 = 0;
            HY7X00SDK.Instance.GetCard_CANIO_OutPort(CardNo, NodeID, PortNo, ref IoValue1);
            return IoValue1;
        }
        ...
        {
            return HY7X00SDK.Instance.GetCardOutBit(CardNo, bitno);
        }
        ...
        {
            return HY7X00SDK.Instance.SetCardWriteOutBit(CardNo, bitno, on_off);
        }
        ...
        public int SetCardCANIOOutBit(int CardNo, int NodeID, int IoBit, int IoValue)
        {
            //IoBit = 0;
            //IoValue = 1;
            return HY7X00SDK.Instance.SetCard_CANIO_OutBit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, (ushort)IoValue);
        }
        ...
        /// <param name="outport_val">IO 值（把对应位置0：打开输出口，对应位置1：关闭输出口）</param>
        /// <returns></returns>
        public int SetCardPortNoOutPort(int CardNo, int bitMark, uint outport_val)
        {
            return HY7X00SDK.Instance.SetCardOutPort(CardNo, bitMark, outport_val);
        }
        ...
        {
            //return DMC_E3032SDK.Instance.NmcReadOutbitExtern(CardNo, Channel, NoteID, IoBit, ref IoValue);
            return 0;
        }
