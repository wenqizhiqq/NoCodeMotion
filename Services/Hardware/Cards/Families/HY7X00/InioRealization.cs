...
//   源: MotionCardRes/HY7X00/InioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.HY7X00
{
    public class InioRealization : IIOInPut
    {
        ...
        /// 运动控制卡类型
        /// </summary>
        public HY7X00系列MotionCardSwitchEnum CardName { get; set; } = HY7X00系列MotionCardSwitchEnum.HY7400;
        ...
        {
            return HY7X00SDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        public int GetCardInPortNoValue(int CardNo, int portno)
        {
            switch (CardName)
            {
                case HY7X00系列MotionCardSwitchEnum.HY7400:
                    return (int)HY7X00SDK.Instance.GetCardInPort(CardNo, portno);
                //break;
        ...
        public uint GetCardCANIOInPort(int CardNo, int NodeID, int PortNo, ref UInt32 IoValue)
        {
            uint IoValue1 = 0;
            // PortNo = 0;
            HY7X00SDK.Instance.GetCard_CANIO_InPort(CardNo, NodeID, PortNo, ref IoValue1);
