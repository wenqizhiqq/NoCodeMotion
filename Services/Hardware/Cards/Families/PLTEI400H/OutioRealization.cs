...
//   源: MotionCardRes/PLTEI400H/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.PLTEI400H
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return (uint)PLTEI400HSDK.Instance.GetCardOutState(CardNo, portno);
        }
        ...
        {
            uint IoValue1 = 0;
            PLTEI400HSDK.Instance.GetCardCANIOOutPort(CardNo, NodeID, PortNo, ref IoValue1);
            return IoValue1;
        }
        ...
        {
            return PLTEI400HSDK.Instance.GetCardPortNoOutState(CardNo, bitno);
        }
        ...
        {
            return PLTEI400HSDK.Instance.SetCardBitNoInBit(CardNo, bitno, on_off);
        }
        ...
        public int SetCardCANIOOutBit(int CardNo, int NodeID, int IoBit, int IoValue)
        {
            //IoBit = 0;
            //IoValue = 1;
            return PLTEI400HSDK.Instance.SetCardCANIOOutBit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, (ushort)IoValue);
        }
        ...
        {
            return PLTEI400HSDK.Instance.SetCardPortNoOutPort(CardNo, portno, (int)outport_val);
        }
