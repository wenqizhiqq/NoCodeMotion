...
//   源: MotionCardRes/PLTEI400H/InioRealization.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.PLTEI400H
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            return PLTEI400HSDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return (int)PLTEI400HSDK.Instance.GetCardInPortNoValue(CardNo, portno);
        }
        ...
        public uint GetCardCANIOInPort(int CardNo, int NodeID, int PortNo, ref UInt32 IoValue)
        {
            uint IoValue1 = 0;
            // PortNo = 0;
            PLTEI400HSDK.Instance.GetCardCANIOInPort(CardNo, NodeID, PortNo, ref IoValue1);
        ...
        {
            return (int)PLTEI400HSDK.Instance.GetCardInPortValue(CardNo, portno);
        }
