...
//   源: MotionCardRes/PLTEI400H/ExpandInioRealizetion.cs
...
namespace  Samsun.Domain.MotionCard.Common.PLTEI400H
{
    public class ExpandInioRealizetion : IEIOInPut
    {
        ...
        {
            //return PLTEI400HSDK.Instance.EGetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo,ref mode);
            return 0;
        }
        ...
        {
            //return PLTEI400HSDK.Instance.GetExpandADDAIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
            return 0;
        }
        ...
        {
            //return PLTEI400HSDK.Instance.GetExpandIOInBit(CardNo, NodeID, IoBit, ref IoValue);
            return 0;
        }
        ...
        {
            //return PLTEI400HSDK.Instance.GetExpandIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
            return 0;
        }
        ...
        {
            //return PLTEI400HSDK.Instance.SetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo, mode);
            return 0;
        }
