...
//   源: MotionCardRes/PCI9016/PCI9016SDK.cs
...
{
    public class PCI9016SDK
    {
        /// <summary>
        /// 用户定义轴回零参数
        /// </summary>
        public HomeParameModel[] homeConfigArray/* = new HomeParameModel[4]*/;
        private static PCI9016SDK _instance;
        public static PCI9016SDK Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new PCI9016SDK();
                return PCI9016SDK._instance;
            }
            set { PCI9016SDK._instance = value; }
        }
        ...
        {
            card_id = new int[16];
            return CPci9016.p9016_initial(ref card_count, card_id);
        }
        ...
        public int SetCardAxisPos(int axis, int cntr_on, int Pos)
        {
            ...
            //{
            //    axis = card_id[i] * 4 + j;
            //    CPci9016.p9016_set_pos(axis, 0, 0);
            //}
            return CPci9016.p9016_set_pos(axis, cntr_on, Pos);
        }
        ...
        /// <para>如果 vel_mode 为 0，则该轴以 p9016_set_t_profile 中的 start_vel 为速度进行驱动； </para>
        /// <para>如果 vel_mode 为 1，则该轴以 p9016_set_t_profile 中的 max_vel 为速度进行驱动；</para>
        /// <para>如果 vel_mode 为 2，则该轴从 start_vel 加速到 max_vel 后，以 max_vel 为速度进行驱动，运行到减速点后，控制轴开始减速。 在运行过程中，可以使用 p9016_stop 函数使控制轴停止运动。</para>
        /// </summary>
        /// <param name="axis">轴号 </param>
        ...
        {
            return CPci9016.p9016_pmove(axis, dist, dist_mode, vel_mode);
        }
        ...
        {
            return CPci9016.p9016_vmove(axis, plus_dir, vel_mode);
        }
        ...
        /// </summary>
        /// <param name="axis">轴号</param>
        /// <param name="emg_stop"><para>如果控制轴减速停止(EmgStop = 0)，将使用 p9016_set_t_profile 中的 dec 参数进行减速，减速到 start_vel 后，停止运动。</para><para>  如果控制轴立即停止(EmgStop = 1)，则没有减速过程，立即停止运动。</para> </param>
        /// <returns>正常返回 0；  出现错误时返回非 0 值；</returns>
        public int CardAxisStop(int axis, int emg_stop)
        {
            return CPci9016.p9016_stop(axis, emg_stop);
        }
        ...
        public int SetCarsAxisTProfile(int axis, double start_vel, double max_vel, double acc, double dec)
        {
            ...
            return CPci9016.p9016_set_t_profile(axis, start_vel, max_vel, acc, dec);
        }
        ...
        public int SetCarsAxisSProfile(int axis, double start_vel, double max_vel, double acc, double dec, double jerk_percent)
        {
            ...
            return CPci9016.p9016_set_s_profile(axis, start_vel, max_vel, acc, dec, jerk_percent);
        }


        /// <summary>
        /// 配置原点开关有效电平、编码器 index 信号有效电平、回零模式；这些参数在 p9016_home_move 函数中将使用到。 在模式 0（home_mode = 0）情况下，只需要 ORG 信号有效即可， 对 ez_level 可以给任意值； 而在 2 模式下，需要使用到编码器输入的 index 信号，因而需要指定 index 信号的有效电平; 
        /// </summary>
        /// <param name="axis">轴号 </param>
        ...
        {
            return CPci9016.p9016_home_config(axis, mode, org_level, ez_level);
        }



        ///// <summary>
        ///// 驱动指定的轴回零，并立即返回。 回零是否完成，可以通过 p9016_motion_done 查询状态来完成。
        ///// </summary>
        ///// <param name="axis">轴号</param>
        ...
        //{
        //    return CPci9016.p9016_home_move(axis, plus_dir);
        //}
        ...
        {
            return CPci9016.p9016_set_do(card_no, data);
        }
        ...
        {
            return CPci9016.p9016_set_do_bit(card_no, bit_no, data);
        }
        ...
        {
            return CPci9016.p9016_get_do(card_no, ref pData);
        }
        ...
        {
            return CPci9016.p9016_get_di(card_no, ref pData);
        }
        ...
        {
            return CPci9016.p9016_get_di_bit(card_no, bit_no, ref pData);
        }
        ...
        {
            return CPci9016.p9016_get_version(card_no, ref pApi_ver, ref pDriver_ver, ref pLogic_ver);
        }
        ...
        public int GetCardReVersion(int card_no, ref int pLogic_revision)
        {
            ...
            uint v2 = 0;
            uint v3 = 0;
            var s1= CPci9016.p9016_get_version(card_no, ref v1,ref v2,ref v3);
            pLogic_revision = (int)v3;
            return s1;
        }
        ...
        {
            return CPci9016.p9016_set_el_level(axis, active_level);
        }
        ...
        {
            return CPci9016.p9016_set_error_stop_mode(axis, stop_mode);
        }
        ...
        {
            return CPci9016.p9016_set_alarm(axis, enable, active_level);
        }
        ...
        {
            //return CPci9016.p9016_comp_enable(card_no, enable, active_level, ref_source, length);
            return 0;
        }
        ...
        {
            return CPci9016.p9016_set_pls_outmode(axis, pls_outmode);
        }
        ...
        public int SetCardAxisOutMode(int axis, PlusOutModeEnum outmode)
        {
            ...
            return CPci9016.p9016_set_pls_outmode(axis, plsoutmode);
        }
        ...
        {
            return CPci9016.p9016_set_pls_iptmode(axis, pls_iptmode);
        }
        ...
        {
            var res = CPci9016.p9016_get_motion_status(axis, ref pStatus);
        ...
        {
            return CPci9016.p9016_get_io_status(axis, ref io_status);
        }
        ...
        {
            return CPci9016.p9016_get_current_speed(axis, ref pSpeed);
        }
        ...
        {
            return CPci9016.p9016_get_pos(axis, cntr_no, ref pPos);
        }


        #region CPci9016卡 开发文档 未 包含函数
        /// <summary>
        ...
        {
            int error = CPci9016.p9016_home_move(axis, plus_dir);
            if (error == 0 || error == 205)
            {
                uint UState = 0; int error2 = CPci9016.p9016_get_io_status(axis, ref UState);
                ...
                while (true)
                {
                    error2 = CPci9016.p9016_get_io_status(axis, ref UState);
                    ...
                    {
                        CPci9016.p9016_stop(axis, 1); return 205;
                    }
        ...
        {
            int error = -1;
            int error3 = CPci9016.p9016_home_move(axis, reverseBack);
            uint UState1 = 0;
            if (error3 == 0)
            {
                while (true)
                {
                    int error2 = CPci9016.p9016_get_io_status(axis, ref UState);
                    if ((UState >> 2) % 2 == 1 && error2 == 0)
                    {
                        CPci9016.p9016_pmove(axis, dist_mode, 0, 1);
                        while (true)
                        {
                            error2 = CPci9016.p9016_get_motion_status(axis, ref UState);
                            error3 = CPci9016.p9016_get_io_status(axis, ref UState1);
                        ...
                        error = CPci9016.p9016_home_move(axis, plus_dir);
                        if (error != 0)
                            return error;
                    }
                    if (error == 0)
        ...
        {
            return CPci9016.p9016_comp_add_ref(card_no, PosRef);
        }
        /// <summary>
        /// 预留（不能使用，功能不明）
        /// </summary>
        ...
        public int B(int card_no, ref int PosRef)
        {
            ...
            return CPci9016.p9016_comp_get_curRef(card_no,ref PosRef);
        }
        /// <summary>
        /// 预留（不能使用，功能不明）
        /// </summary>
        ...
        public int C(int card_no)
        {
            ...
            return CPci9016.p9016_comp_clr_fifo(card_no);
        }
        /// <summary>
        /// 预留（不能使用，功能不明）
        /// </summary>
        ...
        public int D(int card_no, ref uint Count)
        {
            ...
            return CPci9016.p9016_comp_get_matchCount(card_no,ref Count); 
        }
        /// <summary>
        /// 预留（不能使用，功能不明）
        /// </summary>
        ...
        public int E(int card_no)
        {
            ...
            return CPci9016.p9016_comp_clr_matchCount(card_no);
        }
        ...
        {
            return CPci9016.p9016_comp_get_fifoStatus(card_no, ref stat);
        } 
         */
        #endregion
    }
