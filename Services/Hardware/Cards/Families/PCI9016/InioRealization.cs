...
//   源: MotionCardRes/PCI9016/InioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.PCI9016
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            uint pData = 0;
            PCI9016SDK.Instance.GetCardDI(CardNo, ref pData);
            return (int)pData;
        }
        ...
        {
            uint pData = 0;
            PCI9016SDK.Instance.GetCardDIBit(CardNo, (uint)bitno, ref pData);
            return (int)pData;
        }
        ...
        {
            return PCI9016SDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            uint pdata = 0;
            int result = CPci9016.p9016_get_di(card_no, ref pdata);
            pData = (int)pdata;
            return result;
        }
        ...
        {
            uint pdata = 0;
            int result = CPci9016.p9016_get_di_bit(card_no, (uint)bit_no, ref pdata);
            pData = (int)pdata;
            return result;
        }
        ...
        {
            return PCI9016SDK.Instance.SetCardCompEnable(card_no, enable, active_level, ref_source, length);
        }
        ...
        {
            //uint pData = 0;
            //PCI9016SDK.Instance.GetCardDIBit(CardNo, (uint)IoBit, ref pData);
            //return (int)pData;
