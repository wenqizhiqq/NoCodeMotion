...
//   源: MotionCardRes/DMC3400A/InioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.DMC3400A
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            return DMC3400ASDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        public int GetCardInPortNoValue(int CardNo, int portno)
        {
            ...
            return (int)DMC3400ASDK.Instance.GetCardInBit(CardNo, portno);
        ...
        public uint GetCardCANIOInPort(int CardNo, int NodeID, int PortNo, ref UInt32 IoValue)
        {
            uint IoValue1 = 0;
            // PortNo = 0;
            DMC3400ASDK.Instance.GetCard_CANIO_InPort(CardNo, NodeID, PortNo, ref IoValue1);
        ...
        {
            int error = DMC3400ASDK.Instance.GetCard_CANIO_InBit(CardNo, NoteID, IoBit, ref IoValue);
            return IoValue;
            //return -1;
        }
    }
