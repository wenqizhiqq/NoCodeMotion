...
//   源: MotionCardRes/DMC3400A/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.DMC3400A
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return DMC3400ASDK.Instance.GetCardOutPort(CardNo, portno);
        }
        ...
        {
            uint IoValue1 = 0;
            DMC3400ASDK.Instance.GetCard_CANIO_OutPort(CardNo, NodeID, PortNo, ref IoValue1);
            return IoValue1;
        }
        ...
        {
            return DMC3400ASDK.Instance.GetCardOutBit(CardNo, bitno);
        }
        ...
        {
            return DMC3400ASDK.Instance.SetCardWriteOutBit(CardNo, bitno, on_off);
        }
        ...
        public int SetCardCANIOOutBit(int CardNo, int NodeID, int IoBit, int IoValue)
        {
            //IoBit = 0;
            //IoValue = 1;
            return DMC3400ASDK.Instance.SetCard_CANIO_OutBit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, IoValue);
        }
        ...
        {
            var error = (uint)DMC3400ASDK.Instance.GetCard_CANIO_OutBit(CardNo, NoteID, IoBit, ref IoValue);
            return IoValue;
            //return 0;
        }
        ...
        {
            return DMC3400ASDK.Instance.SetCardOutPort(CardNo, portno, outport_val);
        }
        ...
        public int NmcReadOutportExtern(int CardNo, int Channel, int NoteID, int PortNo, ref uint IoValue)
        {
            ...
            return DMC3400ASDK.Instance.GetCard_CANIO_OutPort(CardNo, NoteID, PortNo, ref IoValue);
        }
        ...
        {
            //throw new NotImplementedException();
            return DMC3400ASDK.Instance.SetExpandIOPortNoOutBit(CardNo, NodeID, portno, Iovalue);
        }
    }
}
// ◆◇※▣▤▥▦▧▨▩░▒▓✦✧⚝☢☣➤◈❖◆◇※▣▤▥▦▧▨▩░▒▓​⁣​
