...
//   源: MotionCardRes/DMC3400A/DMC3400ASDK.cs
...
namespace Samsun.Domain.MotionCard.Common.DMC3400A
{
    public class DMC3400ASDK
    {
        public bool IsInit { get; set; }

        private static DMC3400ASDK _instance;
        public static DMC3400ASDK Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new DMC3400ASDK();
                return DMC3400ASDK._instance;
            }
            set { DMC3400ASDK._instance = value; }
        }
        ...
        {
            return LTDMC.dmc_get_CardInfList(ref CardNum, CardTypeList, CardIdList);
        }
        ...
        {
            return LTDMC.dmc_set_vector_profile_multicoor(cardNo, crd, 0, maxVel, tacc, 0, 0);
        }
        ...
        {
            return LTDMC.dmc_get_card_version((ushort)CardNo, ref CardVersion);
        }
        ...
        {
            return LTDMC.dmc_get_card_soft_version((ushort)CardNo, ref FirmID, ref SubFirmID);
        }
        ...
        {
            return LTDMC.dmc_get_total_axes((ushort)CardNo, ref TotalAxis);
        }
        ...
        {
            int result = LTDMC.dmc_download_configfile((ushort)CardNo, FileName);
#if reversal     //Flip usage instructions based on Rexay's own dynamic link library
            result = LTDMC.dmc_download_configfile_ex((ushort)CardNo, FileName);
#endif
            return result;
        }
        ...
        {
            return LTDMC.dmc_set_pulse_outmode((ushort)CardNo, (ushort)axis, (ushort)outmode);
        }
        ...
        {
            return LTDMC.dmc_get_pulse_outmode((ushort)CardNo, (ushort)axis, ref outmode);
        }
        #endregion
        ...
        {
            return LTDMC.dmc_get_homemode((ushort)CardNo, (ushort)axis, ref home_dir, ref vel, ref mode, ref EZ_count);
        }
        ...
        {
            return LTDMC.dmc_get_home_result((ushort)CardNo, (ushort)axis, ref status);
        }
        ...
        {
            return LTDMC.dmc_set_homelatch_mode((ushort)CardNo, (ushort)axis, enable, logic, source);
        }
        ...
        {
            return LTDMC.dmc_get_homelatch_mode((ushort)CardNo, (ushort)axis, ref enable, ref logic, ref source);
        }
        ...
        {
            return LTDMC.dmc_reset_homelatch_flag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return LTDMC.dmc_get_homelatch_flag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return LTDMC.dmc_get_homelatch_value((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return LTDMC.dmc_set_el_mode((ushort)CardNo, (ushort)axis, el_enable, el_logic, el_mode);
        }
        ...
        {
            return LTDMC.dmc_get_el_mode((ushort)CardNo, (ushort)axis, ref el_enable, ref el_logic, ref el_mode);
        }
        ...
        {
            return LTDMC.dmc_set_softlimit((ushort)CardNo, (ushort)axis, enable, source_sel, SL_action, N_limit, P_limit);
        }
        ...
        {
            return LTDMC.dmc_set_position((ushort)CardNO, (ushort)axis, current_position);
        }
        ...
        {
            return LTDMC.dmc_get_position((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            double pspeed = 0;
            pspeed = LTDMC.dmc_read_current_speed((ushort)CardNo, (ushort)axis);
            if (pspeed < 0)
            {
                pspeed = 0 - pspeed;
            }
        ...
        {
            return LTDMC.dmc_LinkState((ushort)CardNo, ref State);
        }
        ...
        {
            return (int)LTDMC.dmc_stop((ushort)CardNo, (ushort)axis, (ushort)stop_mode);
        }
        ...
        {
            return LTDMC.dmc_set_profile((ushort)CardNo, (ushort)axis, Min_Vel, Max_Vel, Tacc, Tdec, stop_vel);
        }
        ...
        {
            return LTDMC.dmc_get_profile((ushort)CardNo, (ushort)axis, ref Min_Vel, ref Max_Vel, ref Tacc, ref Tdec, ref stop_vel);
        }
        ...
        {
            return LTDMC.dmc_pmove((ushort)CardNo, (ushort)axis, Dist, (ushort)posi_mode);
        }
        ...
        {
            return LTDMC.dmc_change_speed((ushort)CardNo, (ushort)axis, Curr_Vel, Taccdec);
        }
        ...
        {
            return LTDMC.dmc_reset_target_position((ushort)CardNo, (ushort)axis, dist, (ushort)posi_mode);
        }
        ...
        {
            return LTDMC.dmc_update_target_position((ushort)CardNo, (ushort)axis, dist, (ushort)posi_mode);
        }
        #endregion
        ...
        {
            return LTDMC.dmc_set_vector_profile_multicoor((ushort)CardNo, (ushort)Crd, Min_Vel, Max_Vel, Tacc, Tdec, Stop_Vel);
        }
        ...
        {
            return LTDMC.dmc_get_vector_profile_multicoor((ushort)CardNo, (ushort)Crd, ref Min_Vel, ref Max_Vel, ref Tacc, ref Tdec, ref Stop_Vel);
        }
        ...
        {
            return LTDMC.dmc_arc_move_multicoor((ushort)CardNo, (ushort)Crd, AxisList, Target_Pos, Cen_Pos, (ushort)Arc_Dir, (ushort)posi_mode);
        }
        ...
        {
            return LTDMC.dmc_PttTable((ushort)CardNo, (ushort)axis, count, pTime, pPos);
        }
        ...
        {
            return LTDMC.dmc_PtsTable((ushort)CardNo, (ushort)axis, count, pTime, pPos, pPercent);
        }
        ...
        {
            return LTDMC.dmc_PvtTable((ushort)CardNo, (ushort)axis, count, pTime, pPos, pVel);
        }
        ...
        {
            return LTDMC.dmc_PvtMove((ushort)CardNo, (ushort)axisnum, AxisList);
        }
        ...
        {
            return LTDMC.dmc_write_sevon_pin((ushort)CardNo, (ushort)axis, (ushort)on_off);
        }
        ...
        {
            return LTDMC.dmc_read_sevon_pin((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return LTDMC.dmc_read_rdy_pin((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return LTDMC.dmc_set_inp_mode((ushort)CardNo, (ushort)axis, (ushort)enable, (ushort)inp_logic);
        }
        ...
        {
            return LTDMC.dmc_get_inp_mode((ushort)CardNo, (ushort)axis, ref enable, ref inp_logic);
        }
        ...
        {
            return LTDMC.dmc_set_alm_mode((ushort)CardNo, (ushort)axis, (ushort)enable, (ushort)alm_logic, (ushort)alm_action);
        }
        ...
        {
            return LTDMC.dmc_get_alm_mode((ushort)CardNo, (ushort)axis, ref enable, ref alm_logic, ref alm_action);
        }
        ...
        {
            return LTDMC.dmc_write_erc_pin((ushort)CardNo, (ushort)axis, (ushort)sel);
        }
        ...
        {
            return LTDMC.dmc_read_erc_pin((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return LTDMC.dmc_read_inport((ushort)CardNo, (ushort)portno);
        }
        ...
        {
            return LTDMC.dmc_write_outport((ushort)CardNo, (ushort)portno, outport_val);
        }
        ...
        {
            return LTDMC.dmc_reverse_outbit((ushort)CardNo, (ushort)bitno, reverse_time);
        }
        ...
        {
            return LTDMC.dmc_set_io_count_value((ushort)CardNo, (ushort)bitno, (uint)CountValue);
        }
        ...
        {
            return LTDMC.dmc_set_counter_inmode((ushort)CardNo, (ushort)axis, (ushort)mode);
        }
        ...
        {
            return LTDMC.dmc_get_counter_inmode((ushort)CardNo, (ushort)axis, ref mode);
        }
        ...
        {
            return LTDMC.dmc_set_encoder((ushort)CardNo, (ushort)axis, encoder_value);
        }
        /// <summary>
        /// 获取指定轴编码器脉冲计数值
        /// <para>说 明：</para>
        ...
        {
            return LTDMC.dmc_get_encoder((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return LTDMC.dmc_set_ez_mode((ushort)CardNo, (ushort)axis, (ushort)ez_logic, (ushort)ez_mode, filter);
        }
        ...
        {
            return LTDMC.dmc_get_ez_mode((ushort)CardNo, (ushort)axis, ref ez_logic, ref ez_mode, ref filter);
        }
        #endregion
        ...
        {
            return LTDMC.dmc_set_ltc_mode((ushort)CardNo, (ushort)axis, ltc_logic, ltc_mode, filter);
        }
        public int SetCardAxisLatchMode(int CardNo, int axis, int all_enable, int latch_source, int triger_chunnel)
        {
            return LTDMC.dmc_set_latch_mode((ushort)CardNo, (ushort)axis, (ushort)all_enable, (ushort)latch_source, (ushort)triger_chunnel);
        }
        /// <summary>
        /// 获取指定轴的 LTC 信号设置
        /// </summary>
        ...
        {
            return LTDMC.dmc_get_ltc_mode((ushort)CardNo, (ushort)axis, ref ltc_logic, ref ltc_mode, ref filter);
        }
        ...
        {
            return LTDMC.dmc_set_latch_mode((ushort)CardNo, (ushort)axis, all_enable, latch_source, triger_chunnel);
        }
        ...
        {
            return LTDMC.dmc_get_latch_mode((ushort)CardNo, (ushort)axis, ref all_enable, ref latch_source, ref triger_chunnel);
        }
        ...
        {
            return LTDMC.dmc_get_latch_value((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return LTDMC.dmc_get_latch_flag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return LTDMC.dmc_reset_latch_flag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return LTDMC.dmc_get_latch_flag_extern((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return LTDMC.dmc_get_latch_value_extern((ushort)CardNo, (ushort)axis, (ushort)Index);
        }
        ...
        public int SetCardAxisHcmp2dsetEnable(int CardNo, int hcmp, int cmpEnable)
        {
            ...
            return LTDMC.dmc_hcmp_2d_set_enable((ushort)CardNo, (ushort)hcmp, (ushort)cmpEnable);
        }
        ...
        {
            return LTDMC.dmc_compare_add_point((ushort)CardNo, (ushort)axis, pos, (ushort)dir, action, actpara);
        }
        ...
        {
            return LTDMC.dmc_compare_add_point_extern((ushort)CardNo, axis, pos, dir, action, actpara);
        }
        ...
        {
            return LTDMC.dmc_compare_get_points_remained_extern((ushort)CardNo, ref pointNum);
        }
        ...
        {
            return LTDMC.dmc_hcmp_set_mode((ushort)CardNo, (ushort)hcmp, (ushort)cmp_enable);
        }
        /// <summary>
        /// 清除已添加的所有高速位置比较点
        /// </summary>
        ...
        {
            return LTDMC.dmc_hcmp_get_mode((ushort)CardNo, (ushort)hcmp, ref cmp_enable);
        }
        ...
        {
            return LTDMC.dmc_hcmp_add_point((ushort)CardNo, (ushort)hcmp, cmp_pos);
        }
        ...
        {
            return LTDMC.dmc_write_cmp_pin((ushort)CardNo, (ushort)hcmp, (ushort)on_off);
        }
        ...
        {
            return LTDMC.dmc_read_cmp_pin((ushort)CardNo, (ushort)hcmp);
        }
        #endregion
        ...
        {
            return LTDMC.nmc_get_connect_state((ushort)CardNo, ref NodeNum, ref state);
        }
        /// <summary>
        ...
        {
            return LTDMC.nmc_write_outport((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, (uint)IoValue);
        }
        ...
        /// <param name="IoValue">输出值，bit0~bit32 的值分别代表第 0~32 号输出口的电平</param>
        /// <returns>返回值：错误代码</returns>
        public int SetExpandIOPortNoOutBit(int CardNo, int NodeID, int PortNo, uint IoValue)
        {
            return LTDMC.nmc_write_outport((ushort)CardNo, (ushort)NodeID, (ushort)PortNo, IoValue);
        }
