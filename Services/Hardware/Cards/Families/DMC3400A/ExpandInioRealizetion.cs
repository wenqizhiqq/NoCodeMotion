...
//   源: MotionCardRes/DMC3400A/ExpandInioRealizetion.cs
...
namespace Samsun.Domain.MotionCard.Common.DMC3400A
{
    public class ExpandInioRealizetion : IEIOInPut
    {
        ...
        {
            return DMC3400ASDK.Instance.GetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo,ref mode);
        }
        ...
        {
            return DMC3400ASDK.Instance.GetExpandADDAIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return DMC3400ASDK.Instance.GetExpandIOInBit(CardNo, NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return DMC3400ASDK.Instance.GetExpandIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return DMC3400ASDK.Instance.SetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo, mode);
        }
