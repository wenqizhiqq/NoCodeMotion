...
//   源: MotionCardRes/DMC3400A/AxisRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.DMC3400A
{
    public class AxisRealization : IAxis
    {
        ...
        public double GetCardAxisCurrentSpeed(int CardNo, int axis)
        {
            ...
            return DMC3400ASDK.Instance.GetCardAxisCurrentSpeed((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return DMC3400ASDK.Instance.CardAxisStopMulticoor(CardNo, crd, stop_mode);
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.CardAxisChangeSpeed((ushort)CardNo, (ushort)axis, Curr_Vel, Taccdec);
        }
        ...
        {
            return DMC3400ASDK.Instance.SetCardAxisHcmp2dsetEnable(CardNo, hcmp, cmpEnable);
        }
        ...
        public int CardAxisArcMoveCenterUnit(ArcInterpolateparamModel arc)
        {
            ...
            return DMC3400ASDK.Instance.CardAxisArcMoveMulticoor((ushort)arc.CardNo, (ushort)arc.Crd, AxisNums, Target_Pos, Cen_Pos, (ushort)arc.ArcDir, (ushort)arc.PosiMode);
        ...
        {
            return DMC3400ASDK.Instance.GetCardCheckDoneMulticoor(CardNo, crd);
        }
        ...
        public int CardAxisHomeMove()
        {
            ...
            return DMC3400ASDK.Instance.CardAxisHomeMove(AxisWhichCardNo, currentID);
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.CardAxisGetHomeResult(CardNo, axis, ref status);
        }
        ...
        public int CardAxisLineUnit(LineInterpolateparamModel line)
        {
            ...
            return DMC3400ASDK.Instance.CardAxisLineMulticoor(line.CardNo, line.Crd, line.Axis.Length, AxisNums, Target_Pos, line.PosiMode);
        ...
        {
            return DMC3400ASDK.Instance.SetMultiVectorSpeed((ushort)parameter.CardNo, (ushort)parameter.Crd, parameter.minVel,
        ...
        public int CardAxisPointMovement(MotionParamModel mpm)
        {
            ...
            changeAxisID(ref currentID);
            return DMC3400ASDK.Instance.CardAxisPMove(mpm.CardNo, currentID, (int)mpm.Dist, (ushort)mpm.PosiMode);
        ...
        public int CardAxisSerialMovement(MotionParamModel mpm)
        {
            int currentID = mpm.Axis;
            changeAxisID(ref currentID);
            return DMC3400ASDK.Instance.CardAxisVMove(mpm.CardNo, currentID, mpm.Dir);
        ...
        {
            return DMC3400ASDK.Instance.ClearCardHcmpPoints((ushort)CardNo, (ushort)hcmp);
        }
        ...
        public MotionParamModel GetCardAxisAccVel(MotionParamModel mpm)
        {
            ...
            DMC3400ASDK.Instance.GetCardVectorProfileMulticoor(mpm.CardNo, currentID,
        ...
        public int GetCardAxisAlarmState(int CardNo, int axis)
        {
            ...
            int errcode = DMC3400ASDK.Instance.GetCardAxisIOStatus(CardNo, axis);
            return errcode;
        }
        ...
        public double GetCardAxisCurrentPosition(int cntr_no)
        {
            ...
            if (cntr_no == 0)
            {
                ...
                pos = DMC3400ASDK.Instance.GetCardAxisPosition(AxisWhichCardNo, currentID);
            }
            else
            {
                //pos = DMC3400ASDK.Instance.GetCardAxisEncoder(AxisWhichCardNo, AxisID);
                pos = DMC3400ASDK.Instance.GetCardAxisEncoder(AxisWhichCardNo, currentID);
            }
            return pos;
        }
        ...
        public int GetCardAxisCurrentState()
        {
            ...
            int Axis_StateMachine = DMC3400ASDK.Instance.GetCardAxisCheckDone(AxisWhichCardNo, currentID);
        ...
        public int GetCardAxisELLimit()
        {
            ...
            return DMC3400ASDK.Instance.GetCardAxisELMode(AxisWhichCardNo, AxisID, ref el_enable, ref el_logic, ref el_mode);
        }
        /// <summary>
        /// 获取轴的高速回零减速度
        /// </summary>
        ...
        public int GetCardAxisHomeMode()
        {
            ...
            if (DMC3400ASDK.Instance.GetCardAxisHomeMode(AxisWhichCardNo, currentID, ref home_dir, ref vel, ref mode, ref EZ_count) == 1)
            {
                return mode;
            }
            return -1;
        ...
        public int GetCardAxisInitVel(ref int pSpeed)
        {
            ...
            double pspeed = 0;
            int result = 0;
            pspeed = DMC3400ASDK.Instance.GetCardAxisCurrentSpeed(AxisWhichCardNo, currentID);
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.GetCardAxisPosition(card, axis);
        }
        /// <summary>
        /// 读取轴的反向回零距离
        /// </summary>
        ...
        public LimitParamModel GetCardAxisSoftLimit(LimitParamModel lpm)
        {
            ...
            int N_limit = 0;
            int P_limit = 0;
            DMC3400ASDK.Instance.GetCardAxisSoftLimit(lpm.CardNo, lpm.Axis, ref enable, ref source_sel, ref SL_action, ref N_limit, ref P_limit);
            lpm.Enable = enable;
        ...
        {
            var res = DMC3400ASDK.Instance.GetErrorInfo(ErrNum);
            return res;
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.AddCardAxisComparePoint((ushort)CardNo, (ushort)axis, pos, (ushort)dir, action, actpara);
        }
        ...
        public int GetCardAxisComparePointsRunned(int CardNo, int axis, ref int pointNum)
        {
            //int ptNum = 0;
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.GetCardAxisComparePointsRunned(CardNo, axis, ref pointNum);
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.ClearCardAxisComparePoints((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.GetCardAxisCompareConfig(CardNo, axis, ref enable, ref cmp_source);
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.SetCardAxisCompareConfig(CardNo, axis, enable, cmp_source);
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.SetCardAxisHcmpConfig(CardNo, hcmp, axis, cmp_source, cmp_logic, (int)time);
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.SetCardAxisPosition(CardNo, axis, pos);
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.SetCardAxisEncoder(CardNo, axis, encoder_value);
        }
        ...
        {
            return DMC3400ASDK.Instance.SetCardAxisELMode(lpm.CardNo, lpm.Axis, (ushort)lpm.Enable, (ushort)lpm.Plimit, (ushort)lpm.SLAction);
        }
        ...
        {
            return DMC3400ASDK.Instance.CardAxisStop(AxisWhichCardNo, axis, stop_mode);
        }
        ...
        public int SetCardAxisHomeMode(HomeParameModel hpm)
        {
            ...
            return DMC3400ASDK.Instance.SetCardAxisHomeMode(hpm.CardNo, currentID, hpm.HomeDir, /*hpm.HomeSpeed*/hpm.Vel,
        ...
        public int SetCardAxisHomeElReturn(int CardNo, int axis, ushort enable)
        {
             ...
             */
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.SetCardAxisHomeElReturn((ushort)CardNo, (ushort)axis, enable);
        }
        ...
        public int SetCardAxisMotionalVel(MotionParamModel mpm)
        {
            ...
            return DMC3400ASDK.Instance.SetCardVectorProfileMulticoor(mpm.CardNo, currentID,
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.SetCardAxisPosition(CardNo, axis, equiv); ;
        }
        ...
        public int SetCardAxisSoftLimit(LimitParamModel lpm)
        {
            ...
            changeAxisID(ref currentID);
            return DMC3400ASDK.Instance.SetCardAxisSoftLimit(lpm.CardNo, currentID, (ushort)lpm.Enable, (ushort)lpm.SourceSel, (ushort)lpm.SLAction, lpm.Nlimit, lpm.Plimit);
        }
        ...
        public int SetCardAxisSProfile(MotionParamModel mpm)
        {
            int currentID = mpm.Axis;
            changeAxisID(ref currentID);
            return DMC3400ASDK.Instance.SetCardAxisSProfile(mpm.CardNo, currentID, mpm.SMode, mpm.SPara);
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.GetCardAxisProfile(CardNo, axis, ref Min_Vel, ref Max_Vel, ref Tacc, ref Tdec, ref stop_vel);
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.GetCardAxisSProfile(CardNo, axis, s_mode, ref s_para);
        }
        ...
        public int GetCardAxisSevonPin()
        {
            int currentId = AxisID;
            changeAxisID(ref currentId);
            return DMC3400ASDK.Instance.GetCardAxisSevonPin(AxisWhichCardNo, currentId);
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.SetCardAxisInpMode(CardNo, axis, enable, inp_logic);
        }
        ...
        public int CardAxisWriteSevonPin(int on_off)
        {
            int currentId = AxisID;
            changeAxisID(ref currentId);
            return DMC3400ASDK.Instance.CardAxisWriteSevonPin(AxisWhichCardNo, currentId, on_off == 1 ? 0 : 1);
        ...
        public int SetCardAxisTProfile(MotionParamModel mpm)
        {
            lock (dmc3000apilock)
            {
                ...
                return DMC3400ASDK.Instance.SetCardAxisProfile(mpm.CardNo, currentId, mpm.MinVel, mpm.MaxVel, mpm.TaccVel, mpm.TdecVel, mpm.StopVel);
        ...
        {
            return DMC3400ASDK.Instance.SetCardDebugMode(CardNo, FileName);
        }
        ...
        {
            return DMC3400ASDK.Instance.SetCardCompareConfigExtern(CardNo, enable, cmp_source);
        }
        ...
        public int SetCardHcmpEnable(int CardNo, int axis, int hcmp, int cmp_mode = 0)
        {
            ...
            return DMC3400ASDK.Instance.SetCardAxisHcmpMode(CardNo, hcmp, cmp_mode);
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.GetCardAxisLatchValueExtern(CardNo, axis, Index);
        }
        /// <summary>
        /// 从 PC 缓存中读取锁存器已锁存个数
        /// </summary>
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.GetCardAxisLatchFlagExtern((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.SetCardAxisHcmpConfig((ushort)CardNo, (ushort)hcmp, (ushort)axis, (ushort)cmp_source, (ushort)cmp_logic, time);
        }
        /// <summary>
        /// 设置高速比较线性模式参数    
        /// </summary>
        ...
        {
            return DMC3400ASDK.Instance.SetCardHcmpLiner((ushort)CardNo, (ushort)hcmp, Increment, Count);
        }
        /// <summary>
        /// 添加/更新高速比较位置
        /// </summary>
        ...
        {
            return DMC3400ASDK.Instance.AddCardHcmpPoint((ushort)CardNo, (ushort)hcmp, cmp_pos);
        }

        public int SetCardAxisLatchMode(int CardNo, int axis, int all_enable, int latch_source, int triger_chunnel)
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.SetCardAxisLatchMode((ushort)CardNo, (ushort)axis, (ushort)all_enable, (ushort)latch_source, (ushort)triger_chunnel);
        }
        /// <summary>
        /// 设置指定轴的 LTC 信号
        /// </summary>
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.SetCardAxisLtcMode((ushort)CardNo, (ushort)axis, ltc_logic, ltc_mode, filter);
        }
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.GetCardAxisLatchValue((ushort)CardNo, (ushort)axis);
        }
        /// <summary>
        /// 从控制卡内读取指定卡内锁存器的标志位
        /// </summary>
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.GetCardAxisLatchFlag((ushort)CardNo, (ushort)axis);
        }
        public int SetCardHcmpCmpPin(int CardNo, int hcmp, int on_off)
        {
            return DMC3400ASDK.Instance.SetCardHcmpCmpPin((ushort)CardNo, (ushort)hcmp, (ushort)on_off);
        }
        /// <summary>
        /// 读取指定 CMP 端口的电平
        /// </summary>
        ...
        {
            return DMC3400ASDK.Instance.GetCardHcmpCmpPin((ushort)CardNo, (ushort)hcmp);
        }
        /// <summary>
        /// 复位指定卡的锁存器的标志位
        /// </summary>
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.GetCardAxisReserLatchFlag((ushort)CardNo, (ushort)axis);
        }
        /// <summary>
        /// 设置轴的螺距补偿
        /// </summary>
        ...
        {
            return DMC3400ASDK.Instance.GetCardHcmpCurrentState((ushort)CardNo, (ushort)hcmp, ref remained_points, ref current_point, ref runned_points);
        ...
        {
            //return DMC3400ASDK.Instance.DmcSetCardAxisDecStopTime(CardNo, axis, stopTime);
            return -1;
        }
        /// <summary>
        /// 指定轴停止运动
        ...
        {
            changeAxisID(ref axis);
            return DMC3400ASDK.Instance.CardAxisStop(CardNo, axis, stop_mode);
        }
        ...
        public int SetStatusParameter(int axis, bool f, AxisStatusParameterEnum kind)
        {
            ...
            if (kind.ToString() == "正限位" || kind.ToString() == "负限位")
            {
                if (f == true)
                {
                    res = DMC3400ASDK.Instance.SetCardAxisELMode(AxisWhichCardNo, axis, 1, 1, 0);
                }
                else
                {
                    res = DMC3400ASDK.Instance.SetCardAxisELMode(AxisWhichCardNo, axis, 1, 0, 0);
                }
            }
            if (kind.ToString() == "原点位")
            {
                if (f == true)
                {
                    res = DMC3400ASDK.Instance.SetCardAxisHomePinLogic(AxisWhichCardNo, axis, 1, 0);
                }
                else
                {
                    res = DMC3400ASDK.Instance.SetCardAxisHomePinLogic(AxisWhichCardNo, axis, 0, 0);
                }
            }
            if (kind.ToString() == "急停")
            {
                if (f == true)
                {
                    res = DMC3400ASDK.Instance.SetCardAxisEmgMode(AxisWhichCardNo, axis, 1, 1);
                }
                else
                {
                    res = DMC3400ASDK.Instance.SetCardAxisEmgMode(AxisWhichCardNo, axis, 1, 0);
                }
            }
            if (kind.ToString() == "报警")
            {
                if (f == true)
                {
                    res = DMC3400ASDK.Instance.SetCardAxisAlmMode(AxisWhichCardNo, axis, 1, 1, 0);
                }
                else
                {
                    res = DMC3400ASDK.Instance.SetCardAxisAlmMode(AxisWhichCardNo, axis, 1, 0, 0);
                }
            }
