...
//   源: MotionCardRes/DMC_E3032_EtherCAT/InioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.DMC_E3032_EtherCAT
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            return DMC_E3032SDK.Instance.DmcGetCardPortNoInPort(CardNo, portno);
        }
        ...
        {
            return DMC_E3032SDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcGetCardInPortNoBit(CardNo, bitno);
        }
        ...
        {
            return DMC_E3032SDK.Instance.NmcReadInportExtern(CardNo, Channel, NoteID, PortNo, ref IoValue);
        }
