...
//   源: MotionCardRes/DMC_E3032_EtherCAT/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.DMC_E3032_EtherCAT
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardBitNoInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardPortNoOutPort(CardNo, portno, (int)outport_val);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcGetCardPortNoOutPort(CardNo, portno);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcGetCardBitNoOutBit(CardNo, bitno);
        }
        ...
        {
            return DMC_E3032SDK.Instance.NmcReadOutportExtern(CardNo, Channel, NoteID, PortNo, ref IoValue);
        }


        public int NmcWriteOutbitExtern(int CardNo, int Channel, int NoteID, int IoBit, ushort IoValue)
        {
            return DMC_E3032SDK.Instance.NmcWriteOutbitExtern(CardNo, Channel, NoteID, IoBit, IoValue);
        }
        ...
        {
            return DMC_E3032SDK.Instance.NmcWriteOutportExtern(CardNo, Channel, NodeID, portno, Iovalue);
        }
