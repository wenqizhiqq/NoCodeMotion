...
//   源: MotionCardRes/DMC_E3032_EtherCAT/AxisRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.DMC_E3032_EtherCAT
{
    public class AxisRealization : IAxis
    {
        ...
        {
            return DMC_E3032SDK.Instance.DmcCardCrdStopMulticoor(CardNo, crd, stop_mode);//todo:2022.11.26
        }
        ...
        public int GetCardAxisInitVel(/*int CardNo,int Axis, */ref int pSpeed)
        {
            ...
            int result = DMC_E3032SDK.Instance.DmcGetCardAxisCurrentSpeedUnit(CarNo, AxisID, ref pspeed);
            pSpeed = (int)pspeed;
            return result;
        }
        ...
        */
            uint status = 0;
            var res = DMC_E3032SDK.Instance.DmcGetCardAxisIOState(AxisWhichCardNo, AxisID); // 修改了这里PCI9014SDK.Instance.GetAxisCardIOStatus(AxisParameter.AxisID, ref status);
            if (res == 0)
                return (int)status;
            else
                return res;
        ...
        {
            var res = DMC_E3032SDK.Instance.GetErrorInfo(ErrNum);
            return res;
        }

        public string GetEtherCATErrorInfo(int ErrNum)
        {
            var res = DMC_E3032SDK.Instance.GetEtherCATErrorInfo(ErrNum);
            return res;
        }
        ...
        public int CardAxisArcMoveCenterUnit(ArcInterpolateparamModel arc)
        {
            ...
            return DMC_E3032SDK.Instance.DmcCardAxisArcMoveCenterUnit((ushort)arc.CardNo, (ushort)arc.Crd, (ushort)arc.Axis.Length, AxisNums, Target_Pos, Cen_Pos, (ushort)arc.ArcDir, arc.CircleCounts, (ushort)arc.PosiMode);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardVectorSProfile((ushort)CardNo, (ushort)Crd, 0, s_para);
        }
        ...
        public int CardAxisContiArcMoveStart(ArcInterpolateparamModel arc)
        {
            ...
            DMC_E3032SDK.Instance.DmcCardAxisArcMoveRadiusUnit((ushort)arc.CardNo, (ushort)arc.Crd, (ushort)arc.Axis.Length, AxisNums, Target_Pos, arc.ArcRadius, (ushort)arc.ArcDir, arc.CircleCounts, (ushort)arc.PosiMode);
            return DMC_E3032SDK.Instance.DmcCardContiStartList(arc.CardNo, arc.Crd);//开启轴连续插补
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcCardContiStartList(line.CardNo, line.Crd);//开启轴连续插补
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcCardAxisHomeMove((ushort)AxisWhichCardNo, (ushort)AxisID);
        }
        ...
        public int CardAxisLineUnit(LineInterpolateparamModel line)
        {
            ...
            return DMC_E3032SDK.Instance.DmcCardAxisLineUnit(line.CardNo, line.Crd, line.Axis.Length, AxisNums, Target_Pos, line.PosiMode);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcCardAxisPMoveUnit(mpm.CardNo, mpm.Axis, mpm.Dist, (ushort)mpm.PosiMode);
        }
        ...
        public int CardAxesArcMoveCenterUnit(ArcInterpolateparamModel arc)
        {
            ...
            return DMC_E3032SDK.Instance.DmcCardArcMove3PointsUnit((ushort)arc.CardNo, (ushort)arc.Crd, (ushort)arc.Axis.Length, AxisNums, TargetPos, MidPos, arc.CircleCounts, (ushort)arc.PosiMode);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcCardAxisVMove(mpm.CardNo, mpm.Axis, mpm.Dir);
        }
        ...
        {
            return DMC_E3032SDK.Instance.NmcClearCardAxisErrCode(CardNo, axis);
        }
        ...
        public int CardAxisWriteSevonPin(int on_off)
        {
            ...
            */
            ...
            if (on_off == 0)
            {
                res = DMC_E3032SDK.Instance.NmcSetCardAxisDisable(AxisWhichCardNo, AxisID);
            }
            else
            {
                res = DMC_E3032SDK.Instance.NmcSetCardAxisEnable(AxisWhichCardNo, AxisID);
            }
            return res;
        }
        ...
        {
            return DMC_E3032SDK.Instance.NmcSetCardAxisDisable(CardNo, axis);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardContiLookaheadMode(impm.CardNo, impm.Crd, impm.Enable, impm.LookaheadSegments, impm.PathError, impm.LookaheadAcc);
        }
        ...
        public MotionParamModel GetCardAxisAccVel(MotionParamModel mpm)
        {
            ...
            DMC_E3032SDK.Instance.DmcGetCardAxisProfileUnit(mpm.CardNo, mpm.Axis,
        ...
        {
            ushort errcode = 0;
            DMC_E3032SDK.Instance.NmcGetCardAxisErrCode(CardNo, axis, ref errcode);
            return errcode;
        }
        ...
        {
            //double pos = 0;
            //DMC_E3032SDK.Instance.DmcGetCardAxisPositionUnit(AxisWhichCardNo, axis, ref pos);
            //return (int)pos;
            double pos = 0; //
            var res = 0;
            if (cntr_no == 0)
            {
                res = DMC_E3032SDK.Instance.DmcGetCardAxisPositionUnit(AxisWhichCardNo, AxisID, ref pos);
            }
            else
            {
                res = DMC_E3032SDK.Instance.DmcGetCardAxisEncoderUnit(AxisWhichCardNo, AxisID, ref pos);
            }
            if (res != 0)
            {
                return 0;
        ...
        public int GetCardAxisCurrentState(/*int CardNo, int axis*/)
        {
            ...
            var Axis_StateMachine = DMC_E3032SDK.Instance.DmcGetCardAxisCheckDone(AxisWhichCardNo, AxisID);
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardAxisProfileUnit(mpm.CardNo, mpm.Axis,
        ...
        public HomeParameModel GetCardAxisHighHomeProfile(HomeParameModel hpm)
        {
            ...
            double Tdec = 0;
            double offsetpos = 0;
            DMC_E3032SDK.Instance.NmcGetCardAxisHomeProfile(hpm.CardNo, hpm.Axis, ref home_mode, ref Low_Vel, ref High_Vel, ref Tacc, ref Tdec, ref offsetpos);
        ...
        {
            double equiv = 0;
            DMC_E3032SDK.Instance.DmcGetCardAxisEquiv(CardNo, axis, ref equiv);
            return (int)equiv;
        }
        ...
        {
            UInt16 run_mode = 0;
            DMC_E3032SDK.Instance.DmcGetCardAxisRunMode(CardNo, axis, ref run_mode);
            return run_mode;
        }
        ...
        public LimitParamModel GetCardAxisSoftLimit(LimitParamModel lpm)
        {
            ...
            int N_limit = 0;
            int P_limit = 0;
            DMC_E3032SDK.Instance.DmcGetCardAxisSoftLimit(lpm.CardNo, lpm.Axis, ref enable, ref source_sel, ref SL_action, ref N_limit, ref P_limit);
            lpm.Enable = enable;
        ...
        {
            ushort errcode = 0;
            DMC_E3032SDK.Instance.NmcGetCardErrcode(CardNo, channel, ref errcode);
            return errcode;
        }
        ...
        {
            return DMC_E3032SDK.Instance.NmcSetCardAxisEnable(CardNo, axis);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardAxisCompareConfig(CardNo, axis, enable, cmp_source);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardAxisPositionUnit(CardNo, axis, pos);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardAxisHomeMode(hpm.CardNo, hpm.Axis, hpm.HomeDir, hpm.Vel, hpm.HomeMode, hpm.EZcount);
        }
        ...
        {
            return DMC_E3032SDK.Instance.NmcSetCardAxisHomeProfile(hpm.CardNo, hpm.Axis, hpm.HomeMode, hpm.LowVel, hpm.HighVel, hpm.TaccTime, hpm.TdecTime, hpm.EtherCATHomeOffset);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardVectorProfileUnit(imp.CardNo, imp.Crd, imp.MinVel, imp.MaxVel, imp.TaccTime, imp.TdecTime, imp.StopVel);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardAxisEquiv(CardNo, axis, equiv);
        }
        ...
        {
            return DMC_E3032SDK.Instance.NmcSetCardAxisRunMode(CardNo, axis, runmode);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardAxisSoftLimit(lpm.CardNo, lpm.Axis, lpm.Enable, lpm.SourceSel, lpm.SLAction, lpm.Nlimit, lpm.Plimit);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardAxisSProfile(mpm.CardNo, mpm.Axis, mpm.SMode, mpm.SPara);
        }
        ...
        public int SetCardAxisTProfile(MotionParamModel mpm)
        {
            ...
            返回值：错误代码
             */
            return DMC_E3032SDK.Instance.DmcSetCardAxisProfileUnit(mpm.CardNo, mpm.Axis, mpm.MinVel, mpm.MaxVel, mpm.TaccVel, mpm.TdecVel, mpm.StopVel);
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardCompareConfigExtern(CardNo, enable, cmp_source);
        }
        ...
        public int SetCardCompareConfigExternDate(PositionComparatorParamModel pcpm)
        {
            ...
            return DMC_E3032SDK.Instance.DmcAddCardComparePointsExtern(pcpm.CardNo, AxisNums, pcpm.XCmpPos, CmpMode, pcpm.Enable, pcpm.PortSel);
        }
        ...
        {
            //return DMC_E3032SDK.Instance.DmcSetCardAxisCompareConfig(CardNo, axis, enable, cmp_source);
            return DMC_E3032SDK.Instance.DmcSetCardHcmpMode1(CardNo, enable, cmp_source);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardLeadScrewCompConfig(pcm.CardNo, pcm.Axis, pcm.n,
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardLeadScrewCompEnable(CardNo, axis, enable);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardContiLookaheadMode(CardNo, Crd, enable, LookaheadSegments, PathError, LookaheadAcc);
        }
        /// <summary>
        /// 设置减速轴停止时间
        /// </summary>
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardAxisDecStopTime(CardNo, axis, stopTime);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcCardAxisStop(CardNo, axis, stop_mode);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardVectorProfileUnit(AxisWhichCardNo,
        ...
        {
            //return 0;
            return DMC_E3032SDK.Instance.DmcClearCardAxisComparePoints(CardNo, hcmp);
        }
        ...
        {
            //return 0;
            return DMC_E3032SDK.Instance.DmcAddCardHcmpPoint(CardNo, hcmp, cmp_pos);
        }
        ...
        {
            //return DMC_E3032SDK.Instance.DmcSoftltcGetNumber()
            return 0;
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardDebugMode(CardNo, FileName);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcSetCardAxisEncoderUnit(CardNo, axis, encoder_value);
        }
        ...
        {
            ushort status = 0;
            DMC_E3032SDK.Instance.NmcGetCardAxisStateMachine(AxisWhichCardNo, AxisID, ref status);
        ...
        {
            return DMC_E3032SDK.Instance.DmcGetCardCrdCheckDoneMulticoor(CardNo, crd);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcCardAxisChangeSpeed(CardNo, axis, Curr_Vel, Taccdec);
        }
        ...
        {
            //return DMC_E3032SDK.Instance.DmcSetCardAxisHcmpConfig(CardNo, hcmp, axis, cmp_source, cmp_logic, (int)time);
            return DMC_E3032SDK.Instance.DmcSetCardAxisCompareConfig(CardNo, axis, 1, cmp_source);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcGetCardHomeResult(CardNo, axis, ref status);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcGetCardAxisProfileUnit(CardNo, axis, ref Min_Vel, ref Max_Vel, ref Tacc, ref Tdec, ref stop_vel);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcGetCardAxisSProfile(CardNo, axis, s_mode, ref s_para);
        }
        ...
        {
            return DMC_E3032SDK.Instance.DmcAddCardAxisComparePointsCycle(CardNo, axis, pos, dir, action, (int)actpara, 0);
        ...
        {
            return DMC_E3032SDK.Instance.DmcClearCardAxisComparePoints((ushort)CardNo, (ushort)axis);
        ...
        public double GetCardAxisCurrentSpeed(int CardNo, int axis)
        {
            ...
            var res = DMC_E3032SDK.Instance.DmcGetCardAxisCurrentSpeedUnit(CardNo, axis, ref currentSpeed);
