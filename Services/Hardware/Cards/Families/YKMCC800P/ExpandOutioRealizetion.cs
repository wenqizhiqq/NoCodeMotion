...
//   源: MotionCardRes/YKMCC800P/ExpandOutioRealizetion.cs
...
namespace Samsun.Domain.MotionCard.Common.YKMCC800P
{
    ...
    public class ExpandOutioRealizetion : IEIOOutPut
    {
        ...
        {
            return YKMCC800PSDK.Instance.SetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, mode, buffer_nums);
        }
        ...
        {
            return YKMCC800PSDK.Instance.GetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, ref mode, buffer_nums);
        }
        ...
        {
            return YKMCC800PSDK.Instance.GetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC800PSDK.Instance.GetExpandIOConnectState(CardNo, ref NodeNum, ref state);
        }
        ...
        {
            return YKMCC800PSDK.Instance.GetExpandIOOutBit(CardNo,  NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return YKMCC800PSDK.Instance.GetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC800PSDK.Instance.SetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo,  IoValue);
        }
        ...
        {
            return YKMCC800PSDK.Instance.SetExpandIOConnectState(CardNo, NodeNum, state, baud);
        }
        ...
        {
            return YKMCC800PSDK.Instance.SetExpandIOOutBit(CardNo, NodeID, IoBit, IoValue);
        }
        ...
        {
            return YKMCC800PSDK.Instance.SetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, IoValue);
        }
        ...
        {
            return YKMCC800PSDK.Instance.SaveExpandIoToFlash(CardNo, PortNum, NodeNum);
        }
    }
}
// ◆◇※▣▤▥▦▧▨▩░▒▓✦✧⚝☢☣➤◈❖◆◇※▣▤▥▦▧▨▩░▒▓​⁣​
