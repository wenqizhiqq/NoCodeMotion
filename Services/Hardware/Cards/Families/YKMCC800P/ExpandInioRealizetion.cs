...
//   源: MotionCardRes/YKMCC800P/ExpandInioRealizetion.cs
...
namespace Samsun.Domain.MotionCard.Common.YKMCC800P
{
    public class ExpandInioRealizetion : IEIOInPut
    {
        ...
        {
            return YKMCC800PSDK.Instance.GetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo,ref mode);
        }
        ...
        {
            return YKMCC800PSDK.Instance.GetExpandADDAIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC800PSDK.Instance.GetExpandIOInBit(CardNo, NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return YKMCC800PSDK.Instance.GetExpandIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC800PSDK.Instance.SetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo, mode);
        }
