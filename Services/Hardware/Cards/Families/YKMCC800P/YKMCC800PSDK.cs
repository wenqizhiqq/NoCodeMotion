...
//   源: MotionCardRes/YKMCC800P/YKMCC800PSDK.cs
...
{
    public class YKMCC800PSDK
    {
        public bool IsInit { get; set; }

        private static YKMCC800PSDK _instance;
        public static YKMCC800PSDK Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new YKMCC800PSDK();
                return YKMCC800PSDK._instance;
            }
            set { YKMCC800PSDK._instance = value; }
        }
