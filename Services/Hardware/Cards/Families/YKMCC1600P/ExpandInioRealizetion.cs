...
//   源: MotionCardRes/YKMCC1600P/ExpandInioRealizetion.cs
...
namespace Samsun.Domain.MotionCard.Common.YKMCC1600P
{
    public class ExpandInioRealizetion : IEIOInPut
    {
        ...
        {
            return YKMCC1600PSDK.Instance.GetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo,ref mode);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetExpandADDAIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetExpandIOInBit(CardNo, NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetExpandIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo, mode);
        }
