...
//   源: MotionCardRes/YKMCC1600P/AxisRealization.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.YKMCC1600P
{
    public class AxisRealization : IAxis
    {
        ...
        public double GetCardAxisCurrentSpeed(int CardNo, int axis)
        {
            ...
            return YKMCC1600PSDK.Instance.GetCardAxisCurrentSpeed((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisStopMulticoor(CardNo, crd, stop_mode);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.CardAxisChangeSpeed((ushort)CardNo, (ushort)axis, Curr_Vel, Taccdec);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisResetTargetPosition((ushort)CardNo, (ushort)axis,
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisUpdateTargetPosition((ushort)CardNo, (ushort)axis,
                dist, (ushort)posi_mode);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardCheckDoneMulticoor(CardNo, crd);
        }
        ...
        public int CardAxisHomeMove()
        {
            ...
            return YKMCC1600PSDK.Instance.CardAxisHomeMove(AxisWhichCardNo, currentID);
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.CardAxisGetHomeResult(CardNo, axis, ref status);
        }
        ...
        public int CardAxisPointMovement(MotionParamModel mpm)
        {
            ...
            changeAxisID(ref currentID);
            return YKMCC1600PSDK.Instance.CardAxisPMove(mpm.CardNo, currentID, (int)mpm.Dist,
                (ushort)mpm.PosiMode);
        ...
        public int CardAxisSerialMovement(MotionParamModel mpm)
        {
            int currentID = mpm.Axis;
            changeAxisID(ref currentID);
            return YKMCC1600PSDK.Instance.CardAxisVMove(mpm.CardNo, currentID, mpm.Dir);
        ...
        public int GetCardAxisAlarmState(int CardNo, int axis)
        {
            ...
            int errcode = YKMCC1600PSDK.Instance.GetCardAxisIOStatus(CardNo, axis);
            return errcode;
        }
        ...
        public double GetCardAxisCurrentPosition(int cntr_no)
        {
            ...
            if (cntr_no == 0)
            {
                ...
                pos = YKMCC1600PSDK.Instance.GetCardAxisPosition(AxisWhichCardNo, currentID);
            }
            else
            {
                //pos = DMC3400ASDK.Instance.GetCardAxisEncoder(AxisWhichCardNo, AxisID);
                pos = YKMCC1600PSDK.Instance.GetCardAxisEncoder(AxisWhichCardNo, currentID);
            }
            return pos;
        }
        ...
        public int GetCardAxisCurrentState()
        {
            ...
            int Axis_StateMachine = YKMCC1600PSDK.Instance.GetCardAxisCheckDone(AxisWhichCardNo, currentID);
        ...
        public int GetCardAxisELLimit()
        {
            ...
            return YKMCC1600PSDK.Instance.GetCardAxisELMode(AxisWhichCardNo, AxisID, ref el_enable, ref el_logic, ref el_mode);
        }
        /// <summary>
        /// 获取轴的高速回零减速度
        /// </summary>
        ...
        public int GetCardAxisHomeMode()
        {
            ...
            if (YKMCC1600PSDK.Instance.GetCardAxisHomeMode(AxisWhichCardNo, currentID, ref home_dir, ref vel, ref mode, ref EZ_count) == 1)
            {
                return mode;
            }
            return -1;
        ...
        public int GetCardAxisInitVel(ref int pSpeed)
        {
            ...
            double pspeed = 0;
            int result = 0;
            pspeed = YKMCC1600PSDK.Instance.GetCardAxisCurrentSpeed(AxisWhichCardNo, currentID);
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.GetCardAxisPosition(card, axis);
        }
        /// <summary>
        /// 读取轴的反向回零距离
        /// </summary>
        ...
        public LimitParamModel GetCardAxisSoftLimit(LimitParamModel lpm)
        {
            ...
            int N_limit = 0;
            int P_limit = 0;
            YKMCC1600PSDK.Instance.GetCardAxisSoftLimit(lpm.CardNo, lpm.Axis, ref enable, ref source_sel, ref SL_action, ref N_limit, ref P_limit);
            lpm.Enable = enable;
        ...
        {
            var res = YKMCC1600PSDK.Instance.GetErrorInfo(ErrNum);
            return res;
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.SetCardAxisPosition(CardNo, axis, pos);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.SetCardAxisEncoder(CardNo, axis, encoder_value);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisELMode(lpm.CardNo, lpm.Axis, (ushort)lpm.Enable, (ushort)lpm.Plimit, (ushort)lpm.SLAction);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisStop(AxisWhichCardNo, axis, stop_mode);
        }
        ...
        public int SetCardAxisHomeMode(HomeParameModel hpm)
        {
            ...
            return YKMCC1600PSDK.Instance.SetCardAxisHomeMode(hpm.CardNo, currentID, hpm.HomeDir, /*hpm.HomeSpeed*/hpm.Vel,
        ...
        public int SetCardAxisHomeElReturn(int CardNo, int axis, ushort enable)
        {
             ...
             */
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.SetCardAxisHomeElReturn((ushort)CardNo, (ushort)axis, enable);
        }
        ...
        public int SetCardAxisMotionalVel(MotionParamModel mpm)
        {
            ...
            return YKMCC1600PSDK.Instance.SetCardVectorProfileMulticoor(mpm.CardNo, currentID,
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.SetCardAxisPosition(CardNo, axis, equiv); ;
        }
        ...
        public int SetCardAxisSoftLimit(LimitParamModel lpm)
        {
            ...
            changeAxisID(ref currentID);
            return YKMCC1600PSDK.Instance.SetCardAxisSoftLimit(lpm.CardNo, currentID, (ushort)lpm.Enable, (ushort)lpm.SourceSel, (ushort)lpm.SLAction, lpm.Nlimit, lpm.Plimit);
        }
        ...
        public int SetCardAxisSProfile(MotionParamModel mpm)
        {
            int currentID = mpm.Axis;
            changeAxisID(ref currentID);
            return YKMCC1600PSDK.Instance.SetCardAxisSProfile(mpm.CardNo, currentID, mpm.SMode, mpm.SPara);
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.GetCardAxisProfile(CardNo, axis, ref Min_Vel, ref Max_Vel, ref Tacc, ref Tdec, ref stop_vel);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.GetCardAxisSProfile(CardNo, axis, s_mode, ref s_para);
        }
        ...
        public int GetCardAxisSevonPin()
        {
            int currentId = AxisID ;
            changeAxisID(ref currentId);
            return YKMCC1600PSDK.Instance.GetCardAxisSevonPin(AxisWhichCardNo, currentId);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.SetCardAxisInpMode(CardNo, axis, enable, inp_logic);
        }
        ...
        public int CardAxisWriteSevonPin(int on_off)
        {
            int currentId = AxisID;
            changeAxisID(ref currentId);
            return YKMCC1600PSDK.Instance.CardAxisWriteSevonPin(AxisWhichCardNo, currentId, on_off);
        ...
        public int SetCardAxisTProfile(MotionParamModel mpm)
        {
            lock (dmc3000apilock)
            {
                ...
                return YKMCC1600PSDK.Instance.SetCardAxisProfile(mpm.CardNo, currentId, mpm.MinVel, mpm.MaxVel, mpm.TaccVel, mpm.TdecVel, mpm.StopVel);
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardDebugMode(CardNo, FileName);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.SetCardAxisHcmpConfig((ushort)CardNo, (ushort)hcmp, (ushort)axis, (ushort)cmp_source, (ushort)cmp_logic, time);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.CardAxisStop(CardNo, axis, stop_mode);
        }
        ...
        public int SetStatusParameter(int axis, bool f, AxisStatusParameterEnum kind)
        {
            ...
            if (kind.ToString() == "正限位" || kind.ToString() == "负限位")
            {
                if (f == true)
                {
                    res = YKMCC1600PSDK.Instance.SetCardAxisELMode(AxisWhichCardNo, axis, 1, 1, 0);
                }
                else
                {
                    res = YKMCC1600PSDK.Instance.SetCardAxisELMode(AxisWhichCardNo, axis, 1, 0, 0);
                }
            }
            if (kind.ToString() == "原点位")
            {
                if (f == true)
                {
                    res = YKMCC1600PSDK.Instance.SetCardAxisHomePinLogic(AxisWhichCardNo, axis, 1, 0);
                }
                else
                {
                    res = YKMCC1600PSDK.Instance.SetCardAxisHomePinLogic(AxisWhichCardNo, axis, 0, 0);
                }
            }
            if (kind.ToString() == "急停")
            {
                if (f == true)
                {
                    res = YKMCC1600PSDK.Instance.SetCardAxisEmgMode(AxisWhichCardNo, axis, 1, 1);
                }
                else
                {
                    res = YKMCC1600PSDK.Instance.SetCardAxisEmgMode(AxisWhichCardNo, axis, 1, 0);
                }
            }
            if (kind.ToString() == "报警")
            {
                if (f == true)
                {
                    res = YKMCC1600PSDK.Instance.SetCardAxisAlmMode(AxisWhichCardNo, axis, 1, 1, 0);
                }
                else
                {
                    res = YKMCC1600PSDK.Instance.SetCardAxisAlmMode(AxisWhichCardNo, axis, 1, 0, 0);
                }
            }
        ...
        public int SetCardAxisCompareConfig(int CardNo, int axis, int enable, int cmp_source)
        {
            ...
            return YKMCC1600PSDK.Instance.SetCardAxisCompareConfig(CardNo, axis, enable, cmp_source);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardDAEnable((ushort)CardNo, (ushort)enable);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardDAEnable((ushort)CardNo, ref enable);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardDAOutPut((ushort)CardNo, (ushort)channel, Vout);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardDAOutPut((ushort)CardNo, (ushort)channel, ref Vout);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardADInPut((ushort)CardNo, (ushort)channel, ref Vout);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardADInPutEx((ushort)CardNo, (ushort)channel, ref Vout);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetMultiVectorSpeed((ushort)parameter.CardNo, (ushort)parameter.Crd, parameter.minVel,
        ...
        public MotionParamModel GetCardAxisAccVel(MotionParamModel mpm)
        {
            ...
            YKMCC1600PSDK.Instance.GetCardVectorProfileMulticoor(mpm.CardNo, currentID,
        ...
        public int CardAxisLineUnit(LineInterpolateparamModel line)
        {
            ...
            return YKMCC1600PSDK.Instance.CardAxisLineMulticoor(line.CardNo, line.Crd, line.Axis.Length, AxisNums, Target_Pos, line.PosiMode);
        ...
        public int CardAxisArcMoveCenterUnit(ArcInterpolateparamModel arc)
        {
            ...
            return YKMCC1600PSDK.Instance.CardAxisArcMoveMulticoor((ushort)arc.CardNo, (ushort)arc.Crd, AxisNums, Target_Pos, Cen_Pos, (ushort)arc.ArcDir, (ushort)arc.PosiMode);
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.GetCardAxisCompareConfig(CardNo, axis, ref enable, ref cmp_source);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisComparePointsRemained(CardNo, axis, ref pointNum);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisCompareCurrentPoint(CardNo, axis, ref pos);
        }
        ...
        public int GetCardAxisComparePointsRunned(int CardNo, int axis, ref int pointNum)
        {
            //int ptNum = 0;
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.GetCardAxisComparePointsRunned(CardNo, axis, ref pointNum);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.AddCardAxisComparePoint((ushort)CardNo, (ushort)axis, pos, (ushort)dir, action, actpara);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.ClearCardAxisComparePoints((ushort)CardNo, (ushort)axis);
        }
        ...
        public int SetCardHcmpEnable(int CardNo, int axis, int hcmp, int cmp_mode = 0)
        {
            ...
            return YKMCC1600PSDK.Instance.SetCardAxisHcmpMode(CardNo, hcmp, cmp_mode);
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.SetCardAxisHcmpConfig(CardNo, hcmp, axis, cmp_source, cmp_logic, (int)time);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardHcmpLiner((ushort)CardNo, (ushort)hcmp, Increment, Count);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.ClearCardHcmpPoints((ushort)CardNo, (ushort)hcmp);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.AddCardHcmpPoint((ushort)CardNo, (ushort)hcmp, cmp_pos);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardHcmpCurrentState((ushort)CardNo, (ushort)hcmp, ref remained_points, ref current_point, ref runned_points);
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardHcmpCmpPin((ushort)CardNo, (ushort)hcmp, (ushort)on_off);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardHcmpCmpPin((ushort)CardNo, (ushort)hcmp);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisHcmp2dsetEnable(CardNo, hcmp, cmpEnable);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisHcmp2dsetEnable((ushort)CardNo, 
            ...
            int freq, ushort port_sel, ushort pwm_number)
        {
            ...
            return YKMCC1600PSDK.Instance.SetCardAxisHcmp2dsetConfig((ushort)CardNo, hcmp, cmp_mode,
               ...
               ref int freq, ref ushort port_sel, ref ushort pwm_number)
        {
            ...
            return YKMCC1600PSDK.Instance.GetCardAxisHcmp2dsetConfig((ushort)CardNo, hcmp,
                ref cmp_mode,
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisHcmp2dClearPoints((ushort)CardNo, hcmp);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisHcmp2dAddPoint((ushort)CardNo, hcmp, x_cmp_pos, y_cmp_pos);
        }
...
ref int x_current_point, ref int y_current_point, ref int runned_points, ref ushort current_state)
        {
            return YKMCC1600PSDK.Instance.GetCardAxisHcmp2dCurrentState((ushort)CardNo, hcmp, ref remained_points,
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisHcmp2dForceOutput((ushort)CardNo, hcmp, enable);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardCompareConfigExtern(CardNo, enable, cmp_source);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.ClearCardComparePointsExtern(CardNo);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.AddCardComparePointExtern(CardNo, axis, 
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardCompareCurrentPointExtern((ushort)CardNo, ref pos);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardComparePointsRunnedExtern(CardNo, ref pointNum);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardComparePointsRemainedExtern(CardNo, ref pointNum);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.SetCardAxisLtcMode((ushort)CardNo, (ushort)axis,
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.SetCardAxisLatchMode((ushort)CardNo, 
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.GetCardAxisLatchFlag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.GetCardAxisReserLatchFlag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.GetCardAxisLatchFlagExtern((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.GetCardAxisLatchValueExtern(CardNo, axis, Index);
        }
        ...
        {
            changeAxisID(ref axis);
            return YKMCC1600PSDK.Instance.GetCardAxisLatchValue((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisLatchStopTime((ushort)CardNo, (ushort)axis, time);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisOutMode((ushort)CardNo, (ushort)axis,
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisOutMode((ushort)CardNo, 
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardIoCountMode((ushort)CardNo, (ushort)bitno,
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardIoCountValue((ushort)CardNo, (ushort)bitno, CountValue);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardIoCountValue(CardNo, bitno, ref CountValue);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardReverseOutBit((ushort)CardNo, (ushort)bitno, reverse_time);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisHomelatchMode((ushort)CardNo,
        ...
        {
            return YKMCC1600PSDK.Instance.ClearCardAxisHomelatchFlag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisHomelatchFlag((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisHomelatchValue((ushort)CardNo, (ushort)axis);
        }
        ...
        public int SetCardAxisSetBacklash(int CardNo, int axis, int backlash_value, int backlash_interval,
            int backlash_dir)
        {
            return YKMCC1600PSDK.Instance.SetCardAxisSetBacklash(CardNo, axis, backlash_value, backlash_interval,
                backlash_dir);
        }
            ...
            ref int backlash_interval, ref int backlash_dir)
        {
            ...
            return YKMCC1600PSDK.Instance.GetCardAxisSetBacklash(CardNo, axis, ref backlash_value,
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisLeadscrewCompEnable(CardNo, axis,(ushort)enable);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisLeadscrewCompConfig(pcm.CardNo, pcm.Axis, pcm.n,
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisStopReason(CardNo, axis, ref StopReason);
        }
        ...
        public int SetCardAxisFollowParameter(int CardNo, int slave_axis, int master_axis,
            double followradio)
        {
            return YKMCC1600PSDK.Instance.SetCardAxisFollowParameter(CardNo, slave_axis, master_axis, followradio);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisFollowParameter(CardNo, slave_axis,
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisFollowEnable(CardNo, slave_axis, enable);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisFollowEnable(CardNo, slave_axis, ref enable);
        }
        ...
        public int CardAxisPmotionSync(int CardNo, int axis_num, ushort[] axis_list, int[] aim_pos,
            int posi_mode)
        {
            return YKMCC1600PSDK.Instance.CardAxisPmotionSync(CardNo, axis_num, axis_list,
                 aim_pos, posi_mode);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisPmoveSoftLanding(CardNo, axis, midPos, targetPos,
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisPMotionSoftLanding(CardNo, axis, aim_pos, target_pos,
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisCrdPrm(CardNo, crd, dimension, profile, synVelMax,
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisCrdPrm(CardNo, crd, ref dimension, profile,
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisBufCrdData(CardNo, crd);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufLineData(CardNo, Crd, axisNum,
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufArcnCenterMove(CardNo, Crd, axisNum,
        ...
        public int CardAxisBufArcnRadiusMove(int CardNo, int Crd, ushort axisNum, ushort[] AxisList,
            ...
            short posi_mode, double synVel, double synAcc, double velEnd, double velStart)
        {
            return YKMCC1600PSDK.Instance.CardAxisBufArcnRadiusMove(CardNo, Crd, axisNum,
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufArcn3pointMove(CardNo, Crd, axisNum,  AxisList,
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufIO(CardNo, crd, doType, doMask, doValue);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufDelay(CardNo, crd, delayTime);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufLimitON(CardNo, crd, axis, limitType);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufLimitOff(CardNo, crd, axis, limitType);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufSetStopIO(CardNo, crd, axis,
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufMove(CardNo, crd, moveAxis, pos, vel, acc_time);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufCrdRemainSpace(CardNo, crd, ref pSpace);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufCrdClear(CardNo, crd);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufCrdStart(CardNo, crd);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufCrdPause(CardNo, crd);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufCrdStop(CardNo, crd, mode);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufCrdStatus(CardNo, crd, ref pRun, ref pSegment);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisBufUserSegNum(CardNo, crd, segNum);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisBufUserSegNum(CardNo, crd, ref segNum);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisBufRemainSegNum(CardNo, crd, ref pSegment);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisBufSetOverride(CardNo, crd, synVelRatio);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisBufSetCrdStopDec(CardNo, crd, decSmoothStop, decAbruptStop);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisBufSetCrdStopDec(CardNo, crd, ref decSmoothStop,
                ref decAbruptStop);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisBufGetCrdPos(CardNo, crd, ref pPos);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisBufGetCrdVel(CardNo, crd, ref pSynVel);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufInitLookahead(CardNo, crd, T, accMax, enable);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisBufInitLookahead(CardNo, crd, ref T, ref accMax, ref enable);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.SetCardAxisBufCrdSmooth(CardNo, crd, Smooth);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.GetCardAxisBufCrdSmooth(CardNo, crd, ref Smooth);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufCrdReset(CardNo, crd);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufWaitDI(CardNo, crd, dI_id, di_logic, time_out);
        }
        ...
        public int CardAxisBufPwmOutput(int CardNo, int crd, ushort pwm_no, double pwm_duty,
            double pwm_freq)
        {
            return YKMCC1600PSDK.Instance.CardAxisBufPwmOutput(CardNo, crd, pwm_no, pwm_duty, pwm_freq);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufPwmFollow(CardNo, crd, pwm_no, mode,
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufDelayOutbitToStartPos(CardNo, crd, bitno, on_off,
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufDelayOutbitToStopPos(CardNo, crd, bitno,
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufAheadOutbitToStopPos(CardNo, crd,
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufSetPwmON(CardNo, crd, PwmNo);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisBufSetPwmOFF(CardNo, crd, PwmNo);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisGetLocalcatTotalAdcnum(CardNo,ref TotalIn,ref TotalOut);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisGetLocalcatTotalIonum(CardNo, ref TotalIn, ref TotalOut);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisYKSetLocalcatDaOutput(CardNo, channel, Value);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisGetLocalcatDaOutput(CardNo, channel, ref Value);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisGetLocalcatAdInput(CardNo, channel, ref Value);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisSetLocalcatAdMode(CardNo, channel, mode);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisGetLocalcatAdMode(CardNo, channel,ref mode);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisSetLocalcatDaMode(CardNo, channel, mode);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisGetLocalcatDaMode(CardNo, channel,ref mode);
        }
        ...
        {
            return YKMCC1600PSDK.Instance.CardAxisLocalcatGetErrCode(CardNo, LocalcatNo,ref ErrCode);
        }
