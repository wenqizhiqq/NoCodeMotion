...
//   源: MotionCardRes/YKMCCE3032/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.YKMCC_E3032_EtherCAT
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return YK_MCCE3032SDK.Instance.DmcSetCardBitNoInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return YK_MCCE3032SDK.Instance.DmcSetCardPortNoOutPort(CardNo, portno, outport_val);
        }
        ...
        {
            return YK_MCCE3032SDK.Instance.DmcGetCardPortNoOutPort(CardNo, portno);
        }
        ...
        {
            return YK_MCCE3032SDK.Instance.DmcGetCardBitNoOutBit(CardNo, bitno);
        }
        ...
        {
            return YK_MCCE3032SDK.Instance.NmcReadOutportExtern(CardNo, Channel, NoteID, PortNo, ref IoValue);
        }


        public int NmcWriteOutbitExtern(int CardNo, int Channel, int NoteID, int IoBit, ushort IoValue)
        {
            return YK_MCCE3032SDK.Instance.NmcWriteOutbitExtern(CardNo, Channel, NoteID, IoBit, IoValue);
        }
        ...
        {
            return YK_MCCE3032SDK.Instance.NmcWriteOutportExtern(CardNo, Channel, NodeID, portno, Iovalue);
        }
        ...
        {
            int error = YK_MCCE3032SDK.Instance.NmcReadOutbitExtern(CardNo, Channel, NoteID, IoBit, ref IoValue);
            return IoValue;
            //return 0;
        }
    }
