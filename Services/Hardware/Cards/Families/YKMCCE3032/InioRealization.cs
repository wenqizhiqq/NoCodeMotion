...
//   源: MotionCardRes/YKMCCE3032/InioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.YKMCC_E3032_EtherCAT
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            return YK_MCCE3032SDK.Instance.DmcGetCardPortNoInPort(CardNo, portno);
        }
        ...
        {
            return YK_MCCE3032SDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return YK_MCCE3032SDK.Instance.DmcGetCardInPortNoBit(CardNo, bitno);
        }
        ...
        {
            return YK_MCCE3032SDK.Instance.NmcReadInportExtern(CardNo, Channel, NoteID, PortNo, ref IoValue);
        }
        ...
        {
            int error = YK_MCCE3032SDK.Instance.NmcReadInbitExtern(CardNo, Channel, NoteID, IoBit, ref IoValue);
            return IoValue;
        }
        ///// <summary>
        ///// 获取输入端口的值 
