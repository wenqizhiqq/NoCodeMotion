...
//   源: MotionCardRes/YKMCC800S/ExpandOutioRealizetion.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.YKMCC800S
{
    ...
    public class ExpandOutioRealizetion : IEIOOutPut
    {
        ...
        {
            return YKMCC800SSDK.Instance.SetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, mode, buffer_nums);
        }
        ...
        {
            return YKMCC800SSDK.Instance.GetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, ref mode, buffer_nums);
        }
        ...
        {
            return YKMCC800SSDK.Instance.GetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC800SSDK.Instance.GetExpandIOConnectState(CardNo, ref NodeNum, ref state);
        }
        ...
        {
            return YKMCC800SSDK.Instance.GetExpandIOOutBit(CardNo,  NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return YKMCC800SSDK.Instance.GetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC800SSDK.Instance.SetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo,  IoValue);
        }
        ...
        {
            return YKMCC800SSDK.Instance.SetExpandIOConnectState(CardNo, NodeNum, state, baud);
        }
        ...
        {
            return YKMCC800SSDK.Instance.SetExpandIOOutBit(CardNo, NodeID, IoBit, IoValue);
        }
        ...
        {
            return YKMCC800SSDK.Instance.SetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, IoValue);
        }
        ...
        {
            return YKMCC800SSDK.Instance.SaveExpandIoToFlash(CardNo, PortNum, NodeNum);
        }
    }
}
// ◆◇※▣▤▥▦▧▨▩░▒▓✦✧⚝☢☣➤◈❖◆◇※▣▤▥▦▧▨▩░▒▓​⁣​
