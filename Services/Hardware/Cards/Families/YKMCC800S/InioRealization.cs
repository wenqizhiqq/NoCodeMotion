...
//   源: MotionCardRes/YKMCC800S/InioRealization.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.YKMCC800S
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            return YKMCC800SSDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        public int GetCardInPortNoValue(int CardNo, int portno)
        {
            ...
            return (int)YKMCC800SSDK.Instance.GetCardInBit(CardNo, portno);
        ...
        public uint GetCardCANIOInPort(int CardNo, int NodeID, int PortNo, ref UInt32 IoValue)
        {
            uint IoValue1 = 0;
            // PortNo = 0;
            YKMCC800SSDK.Instance.GetCard_CANIO_InPort(CardNo, NodeID, PortNo, ref IoValue1);
            IoValue = IoValue1;
        ...
        {
            return (int)YKMCC800SSDK.Instance.GetCardInPort(CardNo, portno);
        }
        /// <summary>
        /// 设置卡Com口使能
        /// </summary>
        ...
        {
            int error = YKMCC800SSDK.Instance.GetCard_CANIO_InBit(CardNo, NoteID, IoBit, ref IoValue);
            return IoValue;
            //return -1;
        }
    }
