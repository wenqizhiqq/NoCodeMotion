...
//   源: MotionCardRes/YKMCC800S/YKMCC800SSDK.cs
...
{
    public class YKMCC800SSDK
    {
        public bool IsInit { get; set; }

        private static YKMCC800SSDK _instance;
        public static YKMCC800SSDK Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new YKMCC800SSDK();
                return YKMCC800SSDK._instance;
            }
            set { YKMCC800SSDK._instance = value; }
        }
        ...
        public int CardAxisLineMulticoor(int CardNo, int Crd, int axisNum, UInt16[] axisList, int[] DistList, int posi_mode)
        {
            ...
            // return MCC800S.YK_line_multicoor((ushort)CardNo, (ushort)Crd, (ushort)axisNum, axisList, list2.ToArray(), (ushort)posi_mode);
            return 0;
        }
