...
//   源: MotionCardRes/DigitalTwinCard/AxisRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.DigitalTwinCard
{
    public class AxisRealization : IAxis
    {
        ...
        {
            //return VirtualMotionCardSDK.Instance.DmcSetCardAxisDecStopTime(CardNo, axis, stopTime);
            return -1;
        }
        /// <summary>
        /// 指定轴停止运动
        ...
        public int AddCardMulAxisComparePoint(int CardNo, int cmper_No, int dir, ushort action, uint actpara, double[] cmp_pos)
        {
            throw new NotImplementedException();
        }
