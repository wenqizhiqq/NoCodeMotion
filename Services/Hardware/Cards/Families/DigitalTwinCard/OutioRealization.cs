...
//   源: MotionCardRes/DigitalTwinCard/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.DigitalTwinCard
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return VirtualMotionCardSDK.Instance.GetCardOutPort(CardNo, portno);
        }
        ...
        {
            uint IoValue1 = 0;
            VirtualMotionCardSDK.Instance.GetCard_CANIO_OutPort(CardNo, NodeID, PortNo, ref IoValue1);
            return IoValue1;
        }
        ...
        {
            return VirtualMotionCardSDK.Instance.GetCardOutBit(CardNo, bitno);
        }
        ...
        {
            return VirtualMotionCardSDK.Instance.SetCardWriteOutBit(CardNo, bitno, on_off);
        }
        ...
        public int SetCardCANIOOutBit(int CardNo, int NodeID, int IoBit, int IoValue)
        {
            //IoBit = 0;
            //IoValue = 1;
            return VirtualMotionCardSDK.Instance.SetCard_CANIO_OutBit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, (ushort)IoValue);
        }
        ...
        {
            return VirtualMotionCardSDK.Instance.SetCardOutPort(CardNo, portno, outport_val);
        }
        ...
        {
            //throw new NotImplementedException();
            return VirtualMotionCardSDK.Instance.SetExpandIOPortNoOutBit(CardNo, NodeID, portno, (int)Iovalue);
        }       
    }
}
// ◆◇※▣▤▥▦▧▨▩░▒▓✦✧⚝☢☣➤◈❖◆◇※▣▤▥▦▧▨▩░▒▓​⁣​
