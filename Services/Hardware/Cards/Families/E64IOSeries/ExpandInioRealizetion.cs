...
//   源: MotionCardRes/E64IOSeries/ExpandInioRealizetion.cs
...
namespace Samsun.Domain.MotionCard.Common.SLDIOE64
{
    public class ExpandInioRealizetion : IEIOInPut
    {
        ...
        {
            return SLDIOE64SDK.Instance.GetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo,ref mode);
        }
        ...
        {
            return SLDIOE64SDK.Instance.GetExpandADDAIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return SLDIOE64SDK.Instance.GetExpandIOInBit(CardNo, NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return SLDIOE64SDK.Instance.GetExpandIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return SLDIOE64SDK.Instance.SetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo, mode);
        }
