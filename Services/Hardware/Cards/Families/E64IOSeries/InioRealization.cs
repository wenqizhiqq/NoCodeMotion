...
//   源: MotionCardRes/E64IOSeries/InioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.SLDIOE64
{
    public class InioRealization : IIOInPut
    {
        ...
        /// 硬件卡拥有的输入IO的数量
        /// </summary>
        public ushort InIONums { get; set; } = 32;
        /// <summary>
        /// 输入IO的名字
        /// </summary>
        ...
        {
            return SLDIOE64SDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return (int)SLDIOE64SDK.Instance.GetCardInBit(CardNo, portno);
        }
        ...
        public uint GetCardCANIOInPort(int CardNo, int NodeID, int PortNo, ref UInt32 IoValue)
        {
            uint IoValue1 = 0;
            // PortNo = 0;
            SLDIOE64SDK.Instance.GetCard_CANIO_InPort(CardNo, NodeID, PortNo, ref IoValue1);
        ...
        {
            return (int)SLDIOE64SDK.Instance.GetCardInPort(CardNo, portno);
        }
