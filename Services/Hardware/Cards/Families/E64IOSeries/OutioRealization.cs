...
//   源: MotionCardRes/E64IOSeries/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.SLDIOE64
{
    public class OutioRealization : IIOOutPut
    {
        ...
        /// 硬件卡拥有的输出IO的数量
        /// </summary>
        public ushort OutIONums { get; set; } = 32;
        ...
        {
            return SLDIOE64SDK.Instance.GetCardOutPort(CardNo, portno);
        }
        ...
        {
            uint IoValue1 = 0;
            SLDIOE64SDK.Instance.GetCard_CANIO_OutPort(CardNo, NodeID, PortNo, ref IoValue1);
            return IoValue1;
        }
        ...
        {
            return SLDIOE64SDK.Instance.GetCardOutBit(CardNo, bitno);
        }
        ...
        public int SetCardBitNoInBit(int CardNo, int bitno, int on_off)
        {
            ...
            return SLDIOE64SDK.Instance.SetCardWriteOutBit(CardNo, bitno, on_off);
        }
        ...
        public int SetCardCANIOOutBit(int CardNo, int NodeID, int IoBit, int IoValue)
        {
            //IoBit = 0;
            //IoValue = 1;
            return SLDIOE64SDK.Instance.SetCard_CANIO_OutBit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, (ushort)IoValue);
        }
        ...
        {
            return SLDIOE64SDK.Instance.SetCardOutPort(CardNo, portno, outport_val);
        }
