...
//   源: MotionCardRes/E64IOSeries/ExpandOutioRealizetion.cs
...
namespace Samsun.Domain.MotionCard.Common.SLDIOE64
{
    ...
    public class ExpandOutioRealizetion : IEIOOutPut
    {
        ...
        {
            return SLDIOE64SDK.Instance.SetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, mode, buffer_nums);
        }
        ...
        {
            return SLDIOE64SDK.Instance.GetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, ref mode, buffer_nums);
        }
        ...
        {
            return SLDIOE64SDK.Instance.GetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return SLDIOE64SDK.Instance.GetExpandIOConnectState(CardNo, ref NodeNum, ref state);
        }
        ...
        {
            return SLDIOE64SDK.Instance.GetExpandIOOutBit(CardNo,  NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return SLDIOE64SDK.Instance.GetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return SLDIOE64SDK.Instance.SetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo,  IoValue);
        }
        ...
        {
            return SLDIOE64SDK.Instance.SetExpandIOConnectState(CardNo, NodeNum, state, baud);
        }
        ...
        {
            return SLDIOE64SDK.Instance.SetExpandIOOutBit(CardNo, NodeID, IoBit, IoValue);
        }
        ...
        {
            return SLDIOE64SDK.Instance.SetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, IoValue);
        }
        ...
        {
            return SLDIOE64SDK.Instance.SaveExpandIoToFlash(CardNo, PortNum, NodeNum);
        }
    }
}
// ◆◇※▣▤▥▦▧▨▩░▒▓✦✧⚝☢☣➤◈❖◆◇※▣▤▥▦▧▨▩░▒▓​⁣​
