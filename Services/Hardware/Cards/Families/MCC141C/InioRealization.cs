...
//   源: MotionCardRes/MCC141C/InioRealization.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.MCC141C
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            uint pData = 0;
            MCC141CSDK.Instance.GetCardDI(CardNo, ref pData);
            return (int)pData;
        }
        ...
        {
            int pData = 0;
            MCC141CSDK.Instance.GetCardDIBit(CardNo, (uint)bitno, ref pData);
            return (int)pData;
        }
        ...
        {
            return MCC141CSDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return MCC141CSDK.Instance.SetCardCompEnable(card_no, enable, active_level, ref_source, length);
        }
        ...
        {
            //uint pData = 0;
            //MCC141CSDK.Instance.GetCardDIBit(CardNo, (uint)IoBit, ref pData);
            //return (int)pData;
