...
//   源: MotionCardRes/MCC141C/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.MCC141C
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return MCC141CSDK.Instance.SetCardDOBit(CardNo, (uint)bitno, (uint)on_off);
        }
        ...
        {
            return MCC141CSDK.Instance.SetCardDO(CardNo, outport_val);
        }
        ...
        {
            uint pData = 0;
            MCC141CSDK.Instance.GetCardDO(CardNo, ref pData);
            return pData;
        }
        ...
        {
            return MCC141CSDK.Instance.SetCardDO(CardNo, (uint)data);
        }
        ...
        {
            return MCC141CSDK.Instance.SetCardDOBit(CardNo, (uint)BitNo, (uint)data);
        }
        ...
        {
            uint pdata = 0;
            int result = MCC141CSDK.Instance.GetCardDO(CardNo, ref pdata);
            pData = (int)pdata;
            return result;
        }
