...
//   源: MotionCardRes/MCC141C/CardRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.MCC141C
{
    public class CardRealization : ICard
    {
        ...
        public int InitCard()
        {
            ...
            int[] card_id = null;
            int card_count = 0;
            var res = MCC141CSDK.Instance.InitCard(ref card_id, ref card_count);
            var errmsg = MCC141CSDK.Instance.GetErrorInfo(res);
        ...
        public int OpenCard(ref ushort cardnum, ref uint[] cardtypes, ref ushort[] CardID)
        {
            ...
            MCC141CSDK.Instance.homeConfigArray = new HomeParameModel[4 * (cardID[cardCount - 1] + 1)];
            //MCC141CSDK.Instance.homeConfigArray = new HomeParameModel[4 * cardnum];
        ...
        public int GetCardLibVersion(int CardID, ref int LibVer, ref int pDriver_ver, ref int pLogic_ver)
        {
            try
            {
                ...
                uint pdriverVer = 0;
                uint plogicver = 0;
                int result = MCC141CSDK.Instance.GetCardVersion(CardID, ref libVer, ref pdriverVer, ref plogicver);
        ...
        {
            return MCC141CSDK.Instance.GetErrorInfo(ErrNum);
        }
