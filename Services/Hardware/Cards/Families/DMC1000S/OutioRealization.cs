...
//   源: MotionCardRes/DMC1000S/OutioRealization.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.DMC1000S
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return DMC1000SSDK.Instance.GetCardOutPort(CardNo, portno);
        }
        ...
        {
            uint IoValue1 = 0;
            DMC1000SSDK.Instance.GetCard_CANIO_OutPort(CardNo, NodeID, PortNo, ref IoValue1);
            return IoValue1;
        }
        ...
        {
            return DMC1000SSDK.Instance.GetCardOutBit(CardNo, bitno);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardWriteOutBit(CardNo, bitno, on_off);
        }
        ...
        public int SetCardCANIOOutBit(int CardNo, int NodeID, int IoBit, int IoValue)
        {
            //IoBit = 0;
            //IoValue = 1;
            return DMC1000SSDK.Instance.SetCard_CANIO_OutBit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, (ushort)IoValue);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardOutPort(CardNo, portno, outport_val);
        }
