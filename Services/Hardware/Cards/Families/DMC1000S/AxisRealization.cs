...
//   源: MotionCardRes/DMC1000S/AxisRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.DMC1000S
{
    public class AxisRealization : IAxis
    {
        ...
        public int SetCardAxisPulseOutMode(int CardNo, int axis, int outmode)
        {
            ...
            return DMC1000SSDK.Instance.SetCardAxisPulseOutMode(CardNo, axis, outmode); //.d1000_set_pls_outmode((ushort)axis, (ushort)outmode);
        }
        ...
        public int SetCardAxisHomeElReturn(int CardNo, int axis, ushort enable)
        {
            ...
            错误：返回相关错误码
             */
            return DMC1000SSDK.Instance.SetCardAxisHomeElReturn(CardNo, axis, enable);
        }
        ...
        {
            return DMC1000SSDK.Instance.CardAxisStopMulticoor(CardNo, crd, stop_mode);
        }
        ...
        {
            return DMC1000SSDK.Instance.CardAxisChangeSpeed((ushort)CardNo, (ushort)axis, Curr_Vel, Taccdec);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisHcmp2dsetEnable(CardNo, hcmp, cmpEnable);
        }
        ...
        public int CardAxisArcMoveCenterUnit(ArcInterpolateparamModel arc)
        {
            ...
            return DMC1000SSDK.Instance.CardAxisArcMoveMulticoor((ushort)arc.CardNo, (ushort)arc.Crd, AxisNums, Target_Pos, Cen_Pos, (ushort)arc.ArcDir, (ushort)arc.PosiMode);
        ...
        {
            return DMC1000SSDK.Instance.GetCardCheckDoneMulticoor(CardNo, crd);
        }
        ...
        {
            return DMC1000SSDK.Instance.CardAxisHomeMove(AxisWhichCardNo, AxisID);
        }
        ...
        {
            return DMC1000SSDK.Instance.CardAxisGetHomeResult(CardNo, axis, ref status);
        }
        ...
        /// <param name="CardNo">控制卡卡号</param>
        /// <param name="Crd">指定控制卡上的坐标系号；取值范围：0~1</param>
        /// <param name="axisNum">插补轴数，取值范围：DMC3C00：0~11，DMC3800：0~7，DMC3600：0~5DMC1000SSDK：0~3</param>
        ...
        public int CardAxisLineUnit(LineInterpolateparamModel line)
        {
            ...
            return DMC1000SSDK.Instance.CardAxisLineMulticoor(line.CardNo, line.Crd, line.Axis.Length, AxisNums, Target_Pos, line.PosiMode);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetMultiVectorSpeed((ushort)parameter.CardNo, (ushort)parameter.Crd, parameter.minVel,
        ...
        {
            return DMC1000SSDK.Instance.CardAxisPMove(mpm.CardNo, mpm.Axis, (int)mpm.Dist, (ushort)mpm.PosiMode);
        }
        ...
        {
            return DMC1000SSDK.Instance.CardAxisVMove(mpm.CardNo, mpm.Axis, mpm.Dir);
        }
        /// <summary>
        /// 清除已添加的所有高速位置比较点
        /// </summary>
        ...
        {
            return DMC1000SSDK.Instance.ClearCardHcmpPoints((ushort)CardNo, (ushort)hcmp);
        }
        ...
        public MotionParamModel GetCardAxisAccVel(MotionParamModel mpm)
        {
            ...
            DMC1000SSDK.Instance.GetCardVectorProfileMulticoor(mpm.CardNo, mpm.Axis,
        ...
        {
            int errcode = DMC1000SSDK.Instance.GetCardAxisIOStatus(CardNo, axis);
            return errcode;
        }
        ...
        public double GetCardAxisCurrentPosition(int cntr_no)
        {
            ...
            if (cntr_no == 0)
            {
                pos = DMC1000SSDK.Instance.GetCardAxisPosition(AxisWhichCardNo, AxisID);
            }
            else
            {
                pos = DMC1000SSDK.Instance.GetCardAxisEncoder(AxisWhichCardNo, AxisID);
            }
            return pos;
        }
        ...
        public int GetCardAxisCurrentState()
        {
            ...
            int Axis_StateMachine = DMC1000SSDK.Instance.GetCardAxisCheckDone(AxisWhichCardNo, AxisID);
        ...
        public int GetCardAxisELLimit()
        {
            ...
            return DMC1000SSDK.Instance.GetCardAxisELMode(AxisWhichCardNo, AxisID, ref el_enable, ref el_logic, ref el_mode);
        }
        /// <summary>
        /// 获取轴的高速回零减速度
        /// </summary>
        ...
        public int GetCardAxisHomeMode()
        {
            ...
            if (DMC1000SSDK.Instance.GetCardAxisHomeMode(AxisWhichCardNo, AxisID, ref home_dir, ref vel, ref mode, ref EZ_count) == 1)
            {
                return mode;
            }
            return -1;
        ...
        public int GetCardAxisInitVel(ref int pSpeed)
        {
            ...
            double pspeed = 0;
            int result = 0;
            pspeed = DMC1000SSDK.Instance.GetCardAxisCurrentSpeed(AxisWhichCardNo, AxisID);
            result = (int)pspeed;
            return result;
        }
        /// <summary>
        ...
        {
            return DMC1000SSDK.Instance.GetCardAxisPosition(card, axis);
        }
        /// <summary>
        /// 读取轴的反向回零距离
        /// </summary>
        ...
        public LimitParamModel GetCardAxisSoftLimit(LimitParamModel lpm)
        {
            ...
            int N_limit = 0;
            int P_limit = 0;
            DMC1000SSDK.Instance.GetCardAxisSoftLimit(lpm.CardNo, lpm.Axis, ref enable, ref source_sel, ref SL_action, ref N_limit, ref P_limit);
            lpm.Enable = enable;
        ...
        {
            var res = DMC1000SSDK.Instance.GetErrorInfo(ErrNum);
            return res;
        }
        ...
        /// </summary>
        /// <param name="CardNo">控制卡卡号</param>
        /// <param name="axis">指定轴号，取值范围：DMC3C00/3800：0~7，DMC3600：0~5,DMC1000SSDK：0~3</param>
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisCompareConfig(CardNo, axis, enable, cmp_source);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisHcmpConfig(CardNo, hcmp, axis, cmp_source, cmp_logic, (int)time);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisPosition(CardNo, axis, pos);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisEncoder(CardNo, axis, encoder_value);
        }
        ...
        /// <para> name=" axis "：指定轴号，取值范围：DMC3C00/3800：0~7，DMC3600：0~5 DMC1000SSDK：0~3 </para>
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisELMode(lpm.CardNo, lpm.Axis, (ushort)lpm.Enable, (ushort)lpm.Plimit, (ushort)lpm.SLAction);
        }
        ...
        {
            return DMC1000SSDK.Instance.CardAxisStop(AxisWhichCardNo, axis, stop_mode);
        }
        ...
        /// <param name="axis">指定轴号，取值范围：DMC3C00：0~11，DMC3800：0~7，DMC3600：0~5 DMC1000SSDK：0~3 </param>
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisHomeMode(hpm.CardNo, hpm.Axis, hpm.HomeDir, hpm.Vel, hpm.HomeMode, hpm.EZcount);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardVectorProfileMulticoor(mpm.CardNo, mpm.Axis,
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisPosition(CardNo, axis, equiv); ;
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisSoftLimit(lpm.CardNo, lpm.Axis, (ushort)lpm.Enable, (ushort)lpm.SourceSel, (ushort)lpm.SLAction, lpm.Nlimit, lpm.Plimit);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisSProfile(mpm.CardNo, mpm.Axis, mpm.SMode, mpm.SPara);
        }
        ...
        {
            return DMC1000SSDK.Instance.GetCardAxisSevonPin(AxisWhichCardNo, AxisID);
        }
        ...
        {
            return DMC1000SSDK.Instance.CardAxisWriteSevonPin(AxisWhichCardNo, AxisID, on_off);
        }
        ...
        public int SetCardAxisTProfile(MotionParamModel mpm)
        {
            lock (dmc3000apilock)
            {
                ...
                return DMC1000SSDK.Instance.SetCardAxisProfile(mpm.CardNo, mpm.Axis, mpm.MinVel, mpm.MaxVel, mpm.TaccVel, mpm.TdecVel, mpm.StopVel);
            }
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardDebugMode(CardNo, FileName);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardCompareConfigExtern(CardNo, enable, cmp_source);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisHcmpMode(CardNo, enable, cmp_source);
        ...
        {
            return DMC1000SSDK.Instance.GetCardAxisLatchValueExtern(CardNo, axis, Index);
        }
        /// <summary>
        /// 从 PC 缓存中读取锁存器已锁存个数
        /// </summary>
        ...
        {
            return DMC1000SSDK.Instance.GetCardAxisLatchFlagExtern((ushort)CardNo, (ushort)axis);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisHcmpConfig((ushort)CardNo, (ushort)hcmp, (ushort)axis, (ushort)cmp_source, (ushort)cmp_logic, time);
        }
        /// <summary>
        /// 设置高速比较线性模式参数    
        /// </summary>
        ...
        {
            return DMC1000SSDK.Instance.SetCardHcmpLiner((ushort)CardNo, (ushort)hcmp, Increment, Count);
        }
        /// <summary>
        /// 添加/更新高速比较位置
        /// </summary>
        ...
        {
            return DMC1000SSDK.Instance.AddCardHcmpPoint((ushort)CardNo, (ushort)hcmp, cmp_pos);
        }

        public int SetCardAxisLatchMode(int CardNo, int axis, int all_enable, int latch_source, int triger_chunnel)
        {
            return DMC1000SSDK.Instance.SetCardAxisLatchMode((ushort)CardNo, (ushort)axis, (ushort)all_enable, (ushort)latch_source, (ushort)triger_chunnel);
        }
        /// <summary>
        /// 设置指定轴的 LTC 信号
        /// </summary>
        ...
        {
            return DMC1000SSDK.Instance.SetCardAxisLtcMode((ushort)CardNo, (ushort)axis, ltc_logic, ltc_mode, filter);
        }
        ...
        {
            return DMC1000SSDK.Instance.GetCardAxisLatchValue((ushort)CardNo, (ushort)axis);
        }
        /// <summary>
        /// 从控制卡内读取指定卡内锁存器的标志位
        /// </summary>
        ...
        {
            return DMC1000SSDK.Instance.GetCardAxisLatchFlag((ushort)CardNo, (ushort)axis);
        }
        public int SetCardHcmpCmpPin(int CardNo, int hcmp, int on_off)
        {
            return DMC1000SSDK.Instance.SetCardHcmpCmpPin((ushort)CardNo, (ushort)hcmp, (ushort)on_off);
        }
        /// <summary>
        /// 读取指定 CMP 端口的电平
        /// </summary>
        ...
        {
            return DMC1000SSDK.Instance.GetCardHcmpCmpPin((ushort)CardNo, (ushort)hcmp);
        }
        /// <summary>
        /// 复位指定卡的锁存器的标志位
        /// </summary>
        ...
        {
            return DMC1000SSDK.Instance.GetCardAxisReserLatchFlag((ushort)CardNo, (ushort)axis);
        }
        /// <summary>
        /// 设置轴的螺距补偿
        /// </summary>
        ...
        {
            return DMC1000SSDK.Instance.CardAxisStop(CardNo, axis, stop_mode);
        }
        ...
        public double GetCardAxisCurrentSpeed(int CardNo, int axis)
        {
            ...
            var res = DMC1000SSDK.Instance.GetCardAxisCurrentSpeed(CardNo, axis);
