...
//   源: MotionCardRes/DMC1000S/ExpandInioRealizetion.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.DMC1000S
{
    public class ExpandInioRealizetion : IEIOInPut
    {
        ...
        {
            return DMC1000SSDK.Instance.GetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo,ref mode);
        }
        ...
        {
            return DMC1000SSDK.Instance.GetExpandADDAIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return DMC1000SSDK.Instance.GetExpandIOInBit(CardNo, NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return DMC1000SSDK.Instance.GetExpandIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return DMC1000SSDK.Instance.SetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo, mode);
        }
