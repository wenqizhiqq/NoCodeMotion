...
//   源: MotionCardRes/HYMC608/OutioRealization.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.HYMC608
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return MC608SDK.Instance.GetCardOutPort(CardNo, portno);
        }
        ...
        {
            uint IoValue1 = 0;
            MC608SDK.Instance.GetCard_CANIO_OutPort(CardNo, NodeID, PortNo, ref IoValue1);
            return IoValue1;
        }
        ...
        {
            return MC608SDK.Instance.GetCardOutBit(CardNo, bitno);
        }
        ...
        {
            return MC608SDK.Instance.SetCardWriteOutBit(CardNo, bitno, on_off);
        }
        ...
        public int SetCardCANIOOutBit(int CardNo, int NodeID, int IoBit, int IoValue)
        {
            //IoBit = 0;
            //IoValue = 1;
            return MC608SDK.Instance.SetCard_CANIO_OutBit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, (ushort)IoValue);
        }
        ...
        {
            return MC608SDK.Instance.SetCardOutPort(CardNo, portno, outport_val);
        }
