...
//   源: MotionCardRes/HYMC608/InioRealization.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.HYMC608
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            return MC608SDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return (int)MC608SDK.Instance.GetCardInPort(CardNo, portno);
        }
        ...
        public uint GetCardCANIOInPort(int CardNo, int NodeID, int PortNo, ref UInt32 IoValue)
        {
            uint IoValue1 = 0;
            // PortNo = 0;
            MC608SDK.Instance.GetCard_CANIO_InPort(CardNo, NodeID, PortNo, ref IoValue1);
