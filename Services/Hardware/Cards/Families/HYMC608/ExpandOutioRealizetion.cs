...
//   源: MotionCardRes/HYMC608/ExpandOutioRealizetion.cs
...
namespace Samsun.Domain.MotionCard.Common.HYMC608
{
    ...
    public class ExpandOutioRealizetion : IEIOOutPut
    {
        ...
        {
            return MC608SDK.Instance.SetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, mode, buffer_nums);
        }
        ...
        {
            return MC608SDK.Instance.GetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, ref mode, buffer_nums);
        }
        ...
        {
            return MC608SDK.Instance.GetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return MC608SDK.Instance.GetExpandIOConnectState(CardNo, ref NodeNum, ref state);
        }
        ...
        {
            return MC608SDK.Instance.GetExpandIOOutBit(CardNo,  NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return MC608SDK.Instance.GetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return MC608SDK.Instance.SetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo,  IoValue);
        }
        ...
        {
            return MC608SDK.Instance.SetExpandIOConnectState(CardNo, NodeNum, state, baud);
        }
        ...
        {
            return MC608SDK.Instance.SetExpandIOOutBit(CardNo, NodeID, IoBit, IoValue);
        }
        ...
        {
            return MC608SDK.Instance.SetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, IoValue);
        }
        ...
        {
            return MC608SDK.Instance.SaveExpandIoToFlash(CardNo, PortNum, NodeNum);
        }
    }
}
// ◆◇※▣▤▥▦▧▨▩░▒▓✦✧⚝☢☣➤◈❖◆◇※▣▤▥▦▧▨▩░▒▓​⁣​
