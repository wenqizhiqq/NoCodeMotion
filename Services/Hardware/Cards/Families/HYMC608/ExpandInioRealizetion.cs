...
//   源: MotionCardRes/HYMC608/ExpandInioRealizetion.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.HYMC608
{
    public class ExpandInioRealizetion : IEIOInPut
    {
        ...
        {
            return MC608SDK.Instance.GetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo,ref mode);
        }
        ...
        {
            return MC608SDK.Instance.GetExpandADDAIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return MC608SDK.Instance.GetExpandIOInBit(CardNo, NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return MC608SDK.Instance.GetExpandIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return MC608SDK.Instance.SetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo, mode);
        }
