...
//   源: MotionCardRes/YKMCC400S/ExpandInioRealizetion.cs
...
namespace Samsun.Domain.MotionCard.Common.YKMCC400S
{
    public class ExpandInioRealizetion : IEIOInPut
    {
        ...
        {
            return YKMCC400SSDK.Instance.GetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo,ref mode);
        }
        ...
        {
            return YKMCC400SSDK.Instance.GetExpandADDAIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC400SSDK.Instance.GetExpandIOInBit(CardNo, NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return YKMCC400SSDK.Instance.GetExpandIOPortNoInBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC400SSDK.Instance.SetExpandADDAIOInPortNoMode(CardNo, NodeID, PortNo, mode);
        }
