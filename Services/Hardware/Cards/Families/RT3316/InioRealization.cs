...
//   源: MotionCardRes/RT3316/InioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.RT3316
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            uint pData = 0;
            RT3316SDK.Instance.GetCardDI(CardNo, ref pData);
            return (int)pData;
        }
        ...
        {
            uint pData = 0;
            RT3316SDK.Instance.GetCardDIBit(CardNo, (uint)bitno, ref pData);
            return (int)pData;
        }
        ...
        {
            return RT3316SDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return RT3316SDK.Instance.SetCardCompEnable(card_no, enable, active_level, ref_source, length);
        }
