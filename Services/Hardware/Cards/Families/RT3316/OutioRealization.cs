...
//   源: MotionCardRes/RT3316/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.RT3316
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return RT3316SDK.Instance.SetCardDOBit(CardNo, (uint)bitno, (uint)on_off);
        }
        ...
        {
            return RT3316SDK.Instance.SetCardDO(CardNo, outport_val);
        }
        ...
        {
            uint pData = 0;
            RT3316SDK.Instance.GetCardDO(CardNo, ref pData);
            return pData;
        }
        ...
        {
            return RT3316SDK.Instance.SetCardDO(CardNo, (uint)data);
        }
        ...
        {
            return RT3316SDK.Instance.SetCardDOBit(CardNo, (uint)BitNo, (uint)data);
        }
        ...
        {
            uint pdata = 0;
            int result = RT3316SDK.Instance.GetCardDO(CardNo, ref pdata);
            pData = (int)pdata;
            return result;
        }
