...
//   源: MotionCardRes/RT3316/CardRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.RT3316
{
    public class CardRealization : ICard
    {
        ...
        public int InitCard()
        {
            ...
            int[] card_id = null;
            int card_count = 0;
            var res = RT3316SDK.Instance.InitCard(ref card_id, ref card_count);
            var errmsg = RT3316SDK.Instance.GetErrorInfo(res);
        ...
        public int OpenCard(ref ushort cardnum, ref uint[] cardtypes, ref ushort[] CardID)
        {
            ...
            RT3316SDK.Instance.homeConfigArray = new HomeParameModel[4 * (cardID[cardCount - 1] + 1)];
            //RT3316SDK.Instance.homeConfigArray = new HomeParameModel[4 * cardnum];
        ...
        public int GetCardLibVersion(int CardID, ref int LibVer, ref int pDriver_ver, ref int pLogic_ver)
        {
            try
            {
                ...
                uint pdriverVer = 0;
                uint plogicver = 0;
                int result = RT3316SDK.Instance.GetCardVersion(CardID, ref libVer, ref pdriverVer, ref plogicver);
        ...
        {
            return RT3316SDK.Instance.GetErrorInfo(ErrNum);
        }
