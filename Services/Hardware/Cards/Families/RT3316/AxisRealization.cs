...
//   源: MotionCardRes/RT3316/AxisRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.RT3316
{
    public class AxisRealization : IAxis
    {
        ...
        {
            return RT3316SDK.Instance.SetCardAxisPos(AxisID, cntr_on, Pos);
        }
        ...
        public int AxisAlarm
        {
            ...
            {
                uint level = 0;
                var res = RT3316SDK.Instance.GetCardDIBit(AxisWhichCardNo, (uint)AxisID, ref level);
                return 0; // (int)level;
            }
            set
            {
        ...
        {
            uint status = 0;
            var res = RT3316SDK.Instance.GetAxisCardIOStatus(AxisID, ref status);
            if (res == 0)
                return (int)status;
            else
                return res;
        ...
        {
            var res = RT3316SDK.Instance.GetErrorInfo(ErrNum);
            return res;
        }
        ...
        {
            return RT3316SDK.Instance.SetCardAxisHomeConfig(hpm.Axis, hpm.HomeMode, hpm.OrgLevel, hpm.EZlevel);
        }
        ...
        {
            //SetCardAxisHomeProfile();已经设置过
            if (RT3316SDK.Instance.homeConfigArray == null || RT3316SDK.Instance.homeConfigArray.Count() < (4 * (hpm.CardNo + 1))) RT3316SDK.Instance.homeConfigArray = new HomeParameModel[4 * (hpm.CardNo + 1)];
            RT3316SDK.Instance.homeConfigArray[hpm.Axis] = hpm;
            return 0;
        }
        ...
        {
            return RT3316SDK.Instance.SetCardAxisELLevel(lpm.Axis, lpm.ActiveLevel);
        }
        ...
        {
            return RT3316SDK.Instance.SetCardAxisErrorStopMode(axis, stop_mode);
        }
        ...
        {
            return RT3316SDK.Instance.SetCardAxisPos(axis, 0, pos);
        }
        ...
        public int GetCardAxisInitVel(/*int CardNo,int Axis, */ref int pSpeed)
        {
            ...
            double pspeed = 0;
            int result = RT3316SDK.Instance.GetCardAxisCurrentSpeed(AxisID, ref pspeed);
            pSpeed = (int)pspeed;
            return result;
        }
        ...
        public double GetCardAxisCurrentPosition(int cntr_no/*, int Axis*/)
        {
            ...
            //所以写成下面这样
            if (RT3316SDK.Instance.GetCardAxisPos(AxisID, cntr_no, ref pos) == 0)
            {
                return pos;
            }
            return -1;
        ...
        public int GetCardAxisCurrentState()
        {
            ...
            uint u = 0;
            int axis = AxisID;
            var res = RT3316SDK.Instance.GetCardAxisMotionStatus(axis, ref u);
            if (res == 0)
                return (int)u;
            else
                return -1;
        ...
        {
            return RT3316SDK.Instance.SetCardAxisAlarm(axis, enable, active_level);
        }
        ...
        {
            return RT3316SDK.Instance.SetCarsAxisSProfile(mpm.Axis, mpm.MinVel, mpm.MaxVel, mpm.TaccVel, mpm.TdecVel, mpm.JerkPercent);
        }
        ...
        {
            return RT3316SDK.Instance.SetCarsAxisTProfile(mpm.Axis, mpm.MinVel, mpm.MaxVel, mpm.TaccVel, mpm.TdecVel);
        }
        ...
        {
            if (RT3316SDK.Instance.homeConfigArray[AxisID].HomeMode != 2)
            {

                RT3316SDK.Instance.CardAxisHomeMove(AxisID, 0);
                RT3316SDK.Instance.CardAxisPMove(AxisID, (int)RT3316SDK.Instance.homeConfigArray[AxisID].HomeTrigNegMoveDir, 0, 1);
                SetCardAxisTProfile(new MotionParamModel
                {
                    Axis = RT3316SDK.Instance.homeConfigArray[AxisID].Axis,
                    CardNo = RT3316SDK.Instance.homeConfigArray[AxisID].CardNo,
                    MinVel = 1000,
                    MaxVel = 1500,
                    TaccVel = 0.1,
                    TdecVel = 0.1
                });
                return RT3316SDK.Instance.CardAxisHomeMove(AxisID, 0);
            }
            else
                return RT3316SDK.Instance.CardAxisHomeMove(AxisID, 0);
        ...
        {
            return RT3316SDK.Instance.CardAxisPMove(mpm.Axis, (int)mpm.Dist, mpm.PosiMode, mpm.RunMode);
        }
        ...
        {
            return RT3316SDK.Instance.CardAxisVMove(mpm.Axis, mpm.Dir, mpm.RunMode);
        }
        ...
        {
            return RT3316SDK.Instance.CardAxisStop(axis, emg_stop);
        }
        ...
        {
            return RT3316SDK.Instance.SetCardAxisPos(axis, 1, encoder_value);
            //throw new NotImplementedException();
        }
        ...
        public int SetStatusParameter(int axis, bool f, AxisStatusParameterEnum kind)
        {
            ...
            if (kind.ToString() == "正限位" || kind.ToString() == "负限位")
            {
                if (f == true)
                {
                    res = RT3316SDK.Instance.SetCardAxisELLevel(axis, 1);
                }
                else
                {
                    res = RT3316SDK.Instance.SetCardAxisELLevel(axis, 0);
                }
            }
            if (kind.ToString() == "原点位")
            {
                if (f == true)
                {
                    res = RT3316SDK.Instance.SetCardAxisHomeConfig(axis, 0, 1, 0);
                }
                else
                {
                    res = RT3316SDK.Instance.SetCardAxisHomeConfig(axis, 0, 0, 0);
                }
            }
        ...
        public int CardAxisGetHomeResult(int CardNo, int axis, ref ushort status)
        {
            //throw new NotImplementedException();
            uint pstatus = 1;
            var res = RT3316SDK.Instance.GetCardAxisMotionStatus(axis, ref pstatus);
        ...
        public double GetCardAxisCurrentSpeed(int CardNo, int axis)
        {
            ...
            var res = RT3316SDK.Instance.GetCardAxisCurrentSpeed(axis, ref currentSpeed);
