...
//   源: MotionCardRes/VirtualMotionCard/InioRealization.cs
   ...
   public class InioRealization : IIOInPut
    {
        ...
        /// 硬件卡拥有的输入IO的数量
        /// </summary>
        public ushort InIONums { get; set; } = 512;
        /// <summary>
        /// 输入IO的名字
        /// </summary>
        ...
        {
            return (int)VirtualMotionCardSDK.Instance.GetCardInPort(CardNo, portno);
        }
        ...
        {
            uint IoValue1 = 0;
            VirtualMotionCardSDK.Instance.GetCard_CANIO_InPort(CardNo, NodeID, PortNo,ref IoValue1);
            return IoValue1;
        }
        ...
        {
            return (int)VirtualMotionCardSDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return (int)VirtualMotionCardSDK.Instance.SetCardWriteExtendInBit(CardNo, bitno,nodeno, on_off);
        }
