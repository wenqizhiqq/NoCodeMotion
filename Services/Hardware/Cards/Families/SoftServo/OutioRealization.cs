...
//   源: MotionCardRes/SoftServo/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.SoftServo_EtherCAT
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return SoftVersoSDK.Instance.DmcSetCardBitNoInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return SoftVersoSDK.Instance.DmcSetCardPortNoOutPort(CardNo, portno, outport_val);
        }
        ...
        {
            return SoftVersoSDK.Instance.DmcGetCardPortNoOutPort(CardNo, portno);
        }
        ...
        {
            return SoftVersoSDK.Instance.DmcGetCardBitNoOutBit(CardNo, bitno);
        }
        ...
        {
            return SoftVersoSDK.Instance.NmcReadOutportExtern(CardNo, Channel, NoteID, PortNo, ref IoValue);
        }


        public int NmcWriteOutbitExtern(int CardNo, int Channel, int NoteID, int IoBit, ushort IoValue)
        {
            return SoftVersoSDK.Instance.NmcWriteOutbitExtern(CardNo, Channel, NoteID, IoBit, IoValue);
        }
        ...
        {
            return SoftVersoSDK.Instance.NmcWriteOutportExtern(CardNo, Channel, NodeID, portno, Iovalue);
        }
        ...
        {
            int error = SoftVersoSDK.Instance.NmcReadOutbitExtern(CardNo, Channel, NoteID, IoBit, ref IoValue);
            return IoValue;
            //return 0;
        }
    }
