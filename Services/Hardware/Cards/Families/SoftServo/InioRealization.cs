...
//   源: MotionCardRes/SoftServo/InioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.SoftServo_EtherCAT
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            return SoftVersoSDK.Instance.DmcGetCardPortNoInPort(CardNo, portno);
        }
        ...
        {
            return SoftVersoSDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            return SoftVersoSDK.Instance.DmcGetCardInPortNoBit(CardNo, bitno);
        }
        ...
        {
            return SoftVersoSDK.Instance.NmcReadInportExtern(CardNo, Channel, NoteID, PortNo, ref IoValue);
        }
        ...
        {
            int error = SoftVersoSDK.Instance.NmcReadInbitExtern(CardNo, Channel, NoteID, IoBit, ref IoValue);
            return IoValue;
        }
        ///// <summary>
        ///// 获取输入端口的值 
