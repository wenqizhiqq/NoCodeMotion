...
//   源: MotionCardRes/YKMCC400P/ExpandOutioRealizetion.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.YKMCC400P
{
    ...
    public class ExpandOutioRealizetion : IEIOOutPut
    {
        ...
        {
            return YKMCC400PSDK.Instance.SetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, mode, buffer_nums);
        }
        ...
        {
            return YKMCC400PSDK.Instance.GetExpandADDAIOOutPortNoMode(CardNo, NodeID, PortNo, ref mode, buffer_nums);
        }
        ...
        {
            return YKMCC400PSDK.Instance.GetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC400PSDK.Instance.GetExpandIOConnectState(CardNo, ref NodeNum, ref state);
        }
        ...
        {
            return YKMCC400PSDK.Instance.GetExpandIOOutBit(CardNo,  NodeID, IoBit, ref IoValue);
        }
        ...
        {
            return YKMCC400PSDK.Instance.GetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, ref IoValue);
        }
        ...
        {
            return YKMCC400PSDK.Instance.SetExpandADDAIOPortNoOutBit(CardNo, NodeID, PortNo,  IoValue);
        }
        ...
        {
            return YKMCC400PSDK.Instance.SetExpandIOConnectState(CardNo, NodeNum, state, baud);
        }
        ...
        {
            return YKMCC400PSDK.Instance.SetExpandIOOutBit(CardNo, NodeID, IoBit, IoValue);
        }
        ...
        {
            return YKMCC400PSDK.Instance.SetExpandIOPortNoOutBit(CardNo, NodeID, PortNo, IoValue);
        }
        ...
        {
            return YKMCC400PSDK.Instance.SaveExpandIoToFlash(CardNo, PortNum, NodeNum);
        }
    }
}
// ◆◇※▣▤▥▦▧▨▩░▒▓✦✧⚝☢☣➤◈❖◆◇※▣▤▥▦▧▨▩░▒▓​⁣​
