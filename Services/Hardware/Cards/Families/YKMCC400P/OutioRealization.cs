...
//   源: MotionCardRes/YKMCC400P/OutioRealization.cs
...
namespace WenQiZhi.Domain.MotionCard.Common.YKMCC400P
{
    public class OutioRealization : IIOOutPut
    {
        ...
        {
            return YKMCC400PSDK.Instance.GetCardOutPort(CardNo, portno);
        }
        ...
        {
            uint IoValue1 = 0;
            YKMCC400PSDK.Instance.GetCard_CANIO_OutPort(CardNo, NodeID, PortNo, ref IoValue1);
            IoValue = IoValue1;
            return IoValue1;
        }
        ...
        {
            return YKMCC400PSDK.Instance.GetCardOutBit(CardNo, bitno);
        }
        ...
        {
            return YKMCC400PSDK.Instance.SetCardWriteOutBit(CardNo, bitno, on_off);
        }
        ...
        public int SetCardCANIOOutBit(int CardNo, int NodeID, int IoBit, int IoValue)
        {
            //IoBit = 0;
            //IoValue = 1;
            return YKMCC400PSDK.Instance.SetCard_CANIO_OutBit((ushort)CardNo, (ushort)NodeID, (ushort)IoBit, (ushort)IoValue);
        }
        ...
        {
            var error = (uint)YKMCC400PSDK.Instance.GetCard_CANIO_OutBit(CardNo, NoteID, IoBit, ref IoValue);
            return IoValue;
            //return 0;
        }
        ...
        {
            return YKMCC400PSDK.Instance.SetCardOutPort(CardNo, portno, outport_val);
        }
        ...
        public int NmcReadOutportExtern(int CardNo, int Channel, int NoteID, int PortNo, ref uint IoValue)
        {
            ...
            return YKMCC400PSDK.Instance.GetCard_CANIO_OutPort(CardNo, NoteID, PortNo, ref IoValue);
        }
        ...
        {
            //throw new NotImplementedException();
            return YKMCC400PSDK.Instance.SetExpandIOPortNoOutBit(CardNo, NodeID, portno, (int)Iovalue);
        }
    }
}
// ◆◇※▣▤▥▦▧▨▩░▒▓✦✧⚝☢☣➤◈❖◆◇※▣▤▥▦▧▨▩░▒▓​⁣​
