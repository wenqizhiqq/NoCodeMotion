...
//   源: MotionCardRes/DMC2210/OutioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.DMC2210
{
    public class OutioRealization : IIOOutPut
    {
        ...
        /// <param name="bitno">1-20</param>
        /// <param name="on_off"></param>
        /// <returns></returns>
        public int SetCardBitNoInBit(int CardNo, int bitno, int on_off)
        {
            return DMC2210SDK.Instance.SetCardDOBit(CardNo, (uint)bitno, (uint)on_off);
        }
        ...
        {
            return 0;
            // return DMC2210SDK.Instance.SetCardDO(CardNo, outport_val);
        }
        ...
        {
            uint pData = 0;
            DMC2210SDK.Instance.GetCardDO(CardNo, ref pData);
            return pData;
            //return 0;
        }
        ...
        {
            return 0;
            //return DMC2210SDK.Instance.SetCardDO(CardNo, (uint)data);
        }
        ...
        {
            return DMC2210SDK.Instance.SetCardDOBit(CardNo, (uint)BitNo, (uint)data);
        }
        ...
        {
            uint pdata = 0;
            int result = DMC2210SDK.Instance.GetCardDO(CardNo, ref pdata);
            pData = (int)pdata;
            return result;
        }
