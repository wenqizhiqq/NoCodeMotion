...
//   源: MotionCardRes/DMC2210/InioRealization.cs
...
namespace Samsun.Domain.MotionCard.Common.DMC2210
{
    public class InioRealization : IIOInPut
    {
        ...
        {
            return DMC2210SDK.Instance.SetCardWriteInBit(CardNo, bitno, on_off);
        }
        ...
        {
            uint pData = 0;
            DMC2210SDK.Instance.GetCardDI(CardNo, ref pData);
            return (int)pData;
        }
        ...
        {
            uint pData = 0;
            DMC2210SDK.Instance.GetCardDIBit(CardNo, (uint)bitno, ref pData);
            return (int)pData;
        }
        ...
        {
            //uint pdata = 0;
            //int result = DMC2210SDK.Instance.p9014_get_di(card_no, ref pdata);
            //pData = (int)pdata;
            //return result;
            return 0;
        }
        ...
        {
            //uint pdata = 0;
            //int result = DMC2210SDK.Instance.p9014_get_di_bit(card_no, (uint)bit_no, ref pdata);
            //pData = (int)pdata;
            //return result;
            return 0;
        }
        ...
        {
            //return DMC2210SDK.Instance.SetCardCompEnable(card_no, enable, active_level, ref_source, length);
            return 0;
        }
