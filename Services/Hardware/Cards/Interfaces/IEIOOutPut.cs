...
namespace Samsun.Domain.MotionCard.Common
{
    ...
    public interface IEIOOutPut
    {
        ...
        /// 硬件卡拥有的输出IO的数量
        /// </summary>
        ushort EOutIONums { get; set; }
        /// <summary>
        /// 输入IO所属卡的名字
        /// </summary>
        string EOutIOName { get; set; }
        ...
        /// <returns>返回值：错误代码</returns>
        int ESetExpandIOOutBit(int CardNo, int NodeID, int IoBit, int IoValue);
        ...
        /// <param name="IoValue">输出电平，0：低电平，1：高电平</param>
        /// <returns>返回值：错误代码</returns>
        int EGetExpandIOOutBit(int CardNo, int NodeID, int IoBit, ref ushort IoValue);
        ...
        /// <returns>返回值：错误代码</returns>
        int ESetExpandIOPortNoOutBit(int CardNo, int NodeID, int PortNo, int IoValue);
        ...
        /// <returns>返回值：错误代码</returns>
        int EGetExpandIOPortNoOutBit(int CardNo, int NodeID, int PortNo, ref uint IoValue);
        ...
        /// <returns>返回值：错误代码</returns>
        int ESetExpandADDAIOPortNoOutBit(int CardNo, int NodeID, int PortNo, double IoValue);
        ...
        /// <param name="IoValue">输出电平，单位：mV/mA</param>
        /// <returns>返回值：错误代码</returns>
        int EGetExpandADDAIOPortNoOutBit(int CardNo, int NodeID, int PortNo, ref double IoValue);
        ...
        /// <returns>返回值：错误代码</returns>
        int ESetExpandADDAIOOutPortNoMode(int CardNo, int NodeID, int PortNo, int mode, uint buffer_nums);
        ...
        /// <param name="buffer_nums">保留参数</param>
        /// <returns>返回值：错误代码</returns>
        int EGetExpandADDAIOOutPortNoMode(int CardNo, int NodeID, int PortNo, ref ushort mode, uint buffer_nums);
